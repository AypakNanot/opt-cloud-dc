...
import com.optel.tmaster.dc.device.impl.dci.ctc.transform.config.DciPortTransform;
...
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.rev200630.platform.anchors.top.Port;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.rev200630.platform.anchors.top.port.Config;
...
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.transport.line.common.rev200630.Port1;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.transport.line.common.rev200630.transport.line.common.port.top.OpticalPort;
 ...
 * @since 2022/3/3
 **/
public class CtcOptDciPortServiceImpl extends BaseDciPortImpl implements IDeviceServiceWdmCtc {
    @Override
    ...
    public ListenableFuture<RpcResult<SetOpticalPortOutput>> setOpticalPort(SetOpticalPortInput input) {
        @NonNull InstanceIdentifier<org.opendaylight.yang.gen.v1.http.openconfig.net.yang.transport.line.common.rev200630.transport.line.common.port.top.optical.port.Config> child = create(Components.class).child(Component.class, new ComponentKey(input.getName())).child(Port.class).augmentation(Port1.class).child(OpticalPort.class).child(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.transport.line.common.rev200630.transport.line.common.port.top.optical.port.Config.class);
