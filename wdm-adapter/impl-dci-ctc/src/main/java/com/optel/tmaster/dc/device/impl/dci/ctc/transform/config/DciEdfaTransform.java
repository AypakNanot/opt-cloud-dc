...
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.optical.amplifier.rev200630.optical.amplifier.top.optical.amplifier.amplifiers.amplifier.ConfigBuilder;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.transport.types.rev200630.AprEnableType;
...
public class DciEdfaTransform implements PlatformTypeTransform, PortAndTransceiverAndOtdrAndOpticalChannelTypeTransform {
    ...
    public GetEdfaConfigOutput devToGetEdfaConfigOutputApi(OpticalAmplifier opticalAmplifier, Set<String> names) {
        ...
        if (opticalAmplifier.getAmplifiers() != null && opticalAmplifier.getAmplifiers().getAmplifier() != null) {
            Map<OpticalAmplifierKey, org.opendaylight.yang.gen.v1.com.optel.dci.yang.optical.amplifier.rev220208.optical.amplifier.top.OpticalAmplifier> values = new HashMap<>(opticalAmplifier.getAmplifiers().getAmplifier().size());
            for (org.opendaylight.yang.gen.v1.http.openconfig.net.yang.optical.amplifier.rev200630.optical.amplifier.top.optical.amplifier.amplifiers.Amplifier amplifier : opticalAmplifier.getAmplifiers().getAmplifier().values()) {
        ...
        if (opticalAmplifier.getSupervisoryChannels() != null && opticalAmplifier.getSupervisoryChannels().getSupervisoryChannel() != null) {
            ...
            for(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.optical.amplifier.rev200630.optical.amplifier.top.optical.amplifier.supervisory.channels.SupervisoryChannel supervisoryChannel:opticalAmplifier.getSupervisoryChannels().getSupervisoryChannel().values()){
    ...
    public Config apiToConfigDev(SetEdfaConfigInput input){
        ...
        configBuilder.setAprEnable(aprEnable);
