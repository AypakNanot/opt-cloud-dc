...
import com.optel.tmaster.dc.device.impl.dci.ctc.transform.base.EthTypeTransform;
...
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.ethernet.rev200630.Interface1;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.ethernet.rev200630.Interface1Builder;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.ip.rev200630.Subinterface1;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.ip.rev200630.ipv4.top.ipv4.addresses.Address;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.ip.rev200630.ipv4.top.ipv4.addresses.AddressBuilder;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.ip.rev200630.ipv4.top.ipv4.addresses.AddressKey;
...
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.transceiver.rev200630.State1;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.rpc.rev200630.SetNeighborIpInput;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.Config1Builder;
...
public class DciInterfaceTransform implements EthTypeTransform, GeneralUtilTransform {
    ...
    public GetInterfaceOutput devGetInterfaceOutputToApi(Interfaces interfaces) {
        ...
        Map<org.opendaylight.yang.gen.v1.com.optel.dci.yang.interfaces.rev220208.interfaces.top.InterfaceKey, Interface> apiIfMap = new HashMap<>(interfaces.getInterface().size());
        for (org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.rev191119.interfaces.top.interfaces.Interface item : interfaces.getInterface().values()) {
            ...
            if (item.getState() != null) {
                ...
                org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.port.rev200630.State1 portState = state.augmentation(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.port.rev200630.State1.class);
            ...
            if (ethInterface != null) {
                interfaceBuilder.setEthernet(getEthernet(ethInterface.getEthernet()));
            }
            Otn otn = item.getOtn();
            if (otn != null && otn.getState() != null) {
                org.opendaylight.yang.gen.v1.com.optel.dci.yang.interfaces.rev220208.otn.top.OtnBuilder otnBuilder = new OtnBuilder();
            ...
            if (sdh != null && sdh.getState() != null) {
                org.opendaylight.yang.gen.v1.com.optel.dci.yang.interfaces.rev220208.sdh.top.SdhBuilder sdhBuilder = new SdhBuilder();
    ...
    private org.opendaylight.yang.gen.v1.com.optel.dci.yang.interfaces.ethernet.rev220208.ethernet.top.Ethernet getEthernet(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.ethernet.rev200630.ethernet.top.Ethernet ethernet) {
        if (ethernet == null) {
            return null;
        }
        org.opendaylight.yang.gen.v1.com.optel.dci.yang.interfaces.ethernet.rev220208.ethernet.top.EthernetBuilder ethernetBuilder = new org.opendaylight.yang.gen.v1.com.optel.dci.yang.interfaces.ethernet.rev220208.ethernet.top.EthernetBuilder();
        if (ethernet.getState() != null) {
            org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.@Nullable State1 state1 = ethernet.getState().augmentation(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.State1.class);
    ...
    private org.opendaylight.yang.gen.v1.com.optel.dci.yang.interfaces.rev220208.subinterfaces.top.Subinterface getSubInterface(Subinterface subinterface) {
        ...
        org.opendaylight.yang.gen.v1.com.optel.dci.yang.interfaces.rev220208.subinterfaces.top.SubinterfaceBuilder subinterfaceBuilder = new SubinterfaceBuilder();
    ...
    public org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.rev191119.interfaces.top.interfaces._interface.Config apiToConfigDev(Boolean ospf) {
        ConfigBuilder builder = new ConfigBuilder();
        builder.setOspfEnabled(ospf);
    ...
    public org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.rev191119.interfaces.top.interfaces.Interface apiSetClientEthInterfaceInputToDev(SetClientEthInterfaceInput input) {
        ...
        org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.ethernet.rev200630.ethernet.top.EthernetBuilder ethernetBuilder = new org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.ethernet.rev200630.ethernet.top.EthernetBuilder();
        org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.ethernet.rev200630.ethernet.top.ethernet.ConfigBuilder configBuilder = new org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.ethernet.rev200630.ethernet.top.ethernet.ConfigBuilder();
    ...
    public Address apiToAddressDev(SetDcnInterfaceInput interfaceInput) {
        ...
        org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.ip.rev200630.ipv4.top.ipv4.addresses.address.ConfigBuilder configBuilder = new org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.ip.rev200630.ipv4.top.ipv4.addresses.address.ConfigBuilder();
