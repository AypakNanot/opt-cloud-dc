...
import com.optel.tmaster.dc.device.impl.dci.ctc.transform.base.ApsTypeTransform;
...
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.optical.transport.line.protection.rev200630.automatic.protection._switch.top.aps.modules.aps.module.ConfigBuilder;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.rpc.rev200630.SwitchOlpInput;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.rpc.rev200630.SwitchOlpInputBuilder;
...
public class DciApsServiceTransform implements ApsTypeTransform, PlatformTypeTransform {
    ...
    public SwitchOlpInput apiToSwitchOlpInputDev(org.opendaylight.yang.gen.v1.com.optel.device.opt.dci.aps.rev200210.SwitchOlpInput input){
        if(input==null){
            return null;
        }
        SwitchOlpInputBuilder builder=new SwitchOlpInputBuilder();
        builder.setName(input.getName());
    ...
    private Map<ApsConfigsKey, ApsConfigs> devToApsConfigsApiMap(Collection<ApsModule> apsModules) {
        ...
        for (ApsModule apsModule : apsModules) {
            if (apsModule.getState() != null) {
                ...
                apsConfigsBuilder.setApsStatus(devToApsStatusApi(apsModule.getState().getApsStatus()));
