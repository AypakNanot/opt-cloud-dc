...
import com.optel.tmaster.dc.device.impl.dci.ctc.transform.config.DciApsServiceTransform;
...
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.optical.transport.line.protection.rev200630.automatic.protection._switch.top.ApsModules;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.optical.transport.line.protection.rev200630.automatic.protection._switch.top.aps.modules.ApsModule;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.optical.transport.line.protection.rev200630.automatic.protection._switch.top.aps.modules.ApsModuleKey;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.optical.transport.line.protection.rev200630.automatic.protection._switch.top.aps.modules.aps.module.Config;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.optical.transport.line.protection.rev200630.transport.line.protection.top.Aps;
 ...
 * @since 2022/3/25
 **/
public class CtcOptDciApsServiceImpl extends BaseDciApsServiceImpl implements IDeviceServiceWdmCtc {
    @Override
    public ListenableFuture<RpcResult<GetApsConfigsOutput>> getApsConfigs(GetApsConfigsInput input) {
        ...
        ApsModules apsModules = MountTools.queryFromOperational(input.getNeId(), child);
    ...
    public ListenableFuture<RpcResult<SwitchOlpOutput>> switchOlp(SwitchOlpInput input) {
        ...
        ListenableFuture<RpcResult<org.opendaylight.yang.gen.v1.http.openconfig.net.yang.rpc.rev200630.SwitchOlpOutput>> rpcResultListenableFuture = rpcService.switchOlp(dciApsServiceTransform.apiToSwitchOlpInputDev(input));
