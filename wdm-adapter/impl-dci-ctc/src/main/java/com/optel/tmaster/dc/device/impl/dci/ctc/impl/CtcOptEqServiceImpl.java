...
import com.optel.tmaster.dc.device.impl.dci.ctc.transform.config.DciEqServiceTransform;
...
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.rev200630.platform.anchors.top.ptm.Config;
 ...
 * @version V1.0.0
 */
public class CtcOptEqServiceImpl extends BaseDciEqServiceImpl implements IDeviceServiceWdmCtc {

    @Override
    public ListenableFuture<RpcResult<UpdateFanEqOutput>> updateFanEq(UpdateFanEqInput input) {
        @NonNull InstanceIdentifier<org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.fan.rev200630.Config1> iid =
                create(Components.class)
                        .child(Component.class, new ComponentKey(input.getName()))
                        .child(Fan.class)
                        .child(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.rev200630.platform.anchors.top.fan.Config.class)
                        .augmentation(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.fan.rev200630.Config1.class);
    ...
    public ListenableFuture<RpcResult<SwitchMcuOutput>> switchMcu(SwitchMcuInput input) {
        ...
        ListenableFuture<RpcResult<org.opendaylight.yang.gen.v1.http.openconfig.net.yang.rpc.rev200630.SwitchMcuOutput>> rpcResult
    ...
    public ListenableFuture<RpcResult<GetPtmEqOutput>> getPtmEq(GetPtmEqInput input) {
        ...
        Components components = MountTools.queryFromOperational(input.getNeId(), iid);
