...
public interface CommonTypeTransform {
     ...
     * @return api
     */
    default Timeticks64 devTimeticks64ToApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.openconfig.types.rev200630.Timeticks64 value){
        if(value == null){
            return null;
        }
     ...
     * @return api
     */
    default StatInterval devStatIntervalToApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.openconfig.types.rev200630.StatInterval value){
        if(value == null){
            return null;
        }
