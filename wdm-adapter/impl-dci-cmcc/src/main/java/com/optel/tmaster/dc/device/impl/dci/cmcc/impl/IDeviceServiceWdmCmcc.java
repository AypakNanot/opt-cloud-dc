...
/**
 * <pre>
 * opt-cloud-dc - IDeviceServiceWdmCmcc
 * </pre>
 * Wdm Cmcc 设备服务
 * <pre>
 * date              time          author
 ...
 * @version V2.0.0
 */
public interface IDeviceServiceWdmCmcc extends IDeviceServiceWdm, CommonResourceTransform {
    /**
     * 当前服务支持的Yang Mode类型
     *
     * @return 支持的类型
    ...
    default Collection<YangMode> supportDevice() {
        return CollUtil.newArrayList(YangMode.typeOf(YangType.WDM_CMCC));
    }
}