...
public interface EthTypeTransform extends ITransform {
     ...
     * @return api
     */
    default EthernetInterfaceConfig.DuplexMode devDuplexModeToApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.ethernet.rev230426.EthernetInterfaceConfig.DuplexMode duplexMode){
        if(duplexMode == null){
            return null;
        }
        switch (duplexMode){
     ...
     * @return api速率
     */
    default ETHERNETSPEED devEthernetSpeedToApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.ethernet.rev230426.ETHERNETSPEED clazz) {
        if (clazz == null) {
            return null;
        }
     ...
     * @return api
     */
    default org.opendaylight.yang.gen.v1.com.optel.dci.yang.interfaces.ethernet.rev220208.TerminalEthernetProtocolConfig.ClientAls devClientAlsToApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev230426.TerminalEthernetProtocolConfig.ClientAls clientAls){
        if(clientAls == null){
            return null;
        }
        switch (clientAls){
     ...
     * @return api
     */
    default org.opendaylight.yang.gen.v1.com.optel.dci.yang.interfaces.ethernet.rev220208.TerminalEthernetProtocolConfig.ClientFec devClientFecToApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev230426.TerminalEthernetProtocolConfig.ClientFec clientFec){
        if(clientFec == null){
            return null;
        }
        switch (clientFec){
     ...
     * @return dev
     */
    default org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev230426.TerminalEthernetProtocolConfig.ClientAls  apiClientAlsToDev(TerminalEthernetProtocolConfig.ClientAls clientAls){
        if(clientAls == null){
            return null;
        }
        switch (clientAls){
            case ETHERNET:
                return org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev230426.TerminalEthernetProtocolConfig.ClientAls.ETHERNET;
            case LASERSHUTDOWN:
                return org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev230426.TerminalEthernetProtocolConfig.ClientAls.LASERSHUTDOWN;
            case NONE:
                return org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev230426.TerminalEthernetProtocolConfig.ClientAls.NONE;
            default :
                throw NoMatchEnumValueException.getNoMatchEnumValueException(clientAls);
        }
    }
     ...
     * @return dev
     */
    default org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev230426.TerminalEthernetProtocolConfig.ClientFec apiClientFecToDev(TerminalEthernetProtocolConfig.ClientFec clientFec){
        if(clientFec == null){
            return null;
        }
        switch (clientFec){
            case ENABLED:
                return org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev230426.TerminalEthernetProtocolConfig.ClientFec.ENABLED;
            case DISABLED:
                return org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev230426.TerminalEthernetProtocolConfig.ClientFec.DISABLED;
            default:
                throw NoMatchEnumValueException.getNoMatchEnumValueException(clientFec);
        }
    }
