...
import com.optel.tmaster.dc.device.impl.dci.cmcc.transform.config.DciLldpTransform;
 ...
 * 2022/3/11 14:48
 */
public class CmccOptDciLldpServiceImpl extends BaseOptDciLldpServiceImpl implements IDeviceServiceWdmCmcc {
...
//            lldp =new TestData().getLLdp();
        } else {
            lldp = MountTools.queryFromOperational(input.getNeId(), iid);
        }
