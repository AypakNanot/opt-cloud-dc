...
import com.optel.tmaster.dc.device.impl.dci.cmcc.transform.config.DciNeTimeTransform;
...
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.system.rev230426.system.ntp.server.top.Servers;
...
import org.opendaylight.yang.gen.v1.urn.cmcc.yang.rpc.rev230426.SetDatetimeInputBuilder;
import org.opendaylight.yang.gen.v1.urn.cmcc.yang.rpc.rev230426.SetDatetimeOutput;
 ...
 * 2022/3/11 11:07
 */
public class CmccOptDciNeTimeServiceImpl extends BaseDciNeTimeServiceImpl implements IDeviceServiceWdmCmcc {
    ...
    public ListenableFuture<RpcResult<SetNeTimeOutput>> setNeTime(SetNeTimeInput input) {
        ...
        MiniotnRpcService openconfigRpcService = MountTools.getRpcService(input.getNeId(), MiniotnRpcService.class);
