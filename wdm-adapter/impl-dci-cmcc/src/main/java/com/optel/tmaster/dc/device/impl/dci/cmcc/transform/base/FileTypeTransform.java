...
public interface FileTypeTransform extends ITransform {
     ...
     * @return api
     */
    default DownloadMsgType devDownloadMsgTypeToApi(org.opendaylight.yang.gen.v1.urn.cmcc.yang.rpc.rev230426.DownloadMsgType downloadMsgType){
     ...
     * @return api
     */
    default RpcResult devRpcResultToApi(RpcResult rpcResult){
        if(rpcResult==null){
            return null;
        }
        switch (rpcResult){
    ...
    default UploadMsgType devUploadMsgTypeToApi(
        org.opendaylight.yang.gen.v1.urn.cmcc.yang.rpc.rev230426.UploadMsgType uploadMsgType){
     ...
     * @return api
     */
    default Map<FileNamesKey, FileNames> devFileNameToApi(Map<org.opendaylight.yang.gen.v1.urn.cmcc.yang.rpc.rev230426.get.file.list.output.FileNamesKey, org.opendaylight.yang.gen.v1.urn.cmcc.yang.rpc.rev230426.get.file.list.output.FileNames> map){
        if(map==null || map.size()==0){
            return null;
        }
        Map<FileNamesKey, FileNames> resultMap = new HashMap<>(map.size());
        for(org.opendaylight.yang.gen.v1.urn.cmcc.yang.rpc.rev230426.get.file.list.output.FileNames e: map.values()){
