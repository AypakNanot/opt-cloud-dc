...
import org.opendaylight.yang.gen.v1.com.optel.dci.yang.performance.rev220208.get.pm.data.output.grouping.performance.PmDataValue;
import org.opendaylight.yang.gen.v1.com.optel.dci.yang.performance.rev220208.get.pm.data.output.grouping.performance.pm.data.value.InstantAvgMinMaxBuilder;
import org.opendaylight.yang.gen.v1.com.optel.dci.yang.performance.rev220208.get.pm.data.output.grouping.performance.pm.data.value.InstantBuilder;
import org.opendaylight.yang.gen.v1.com.optel.dci.yang.performance.types.rev220208.*;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.performance.rev200630.get.pm.data.output.performance.pm.data.value.Instant;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.performance.rev200630.get.pm.data.output.performance.pm.data.value.InstantAvgMinMax;
...
public interface PerformanceTypeTransform extends ITransform {
     ...
     * @return api
     */
    default PmParameterType devPmParameterTypeToApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.performance.types.rev200630.PmParameterType pmParameterType) {
        ...
        switch (pmParameterType) {
            ...
            case OPTICALPOWER:
                return PmParameterType.OPTICALPOWER;
            ...
            case INPKTS:
                return PmParameterType.INPKTS;
            case OUTPKTS:
                return PmParameterType.OUTPKTS;
            case RSES:
                return PmParameterType.RSES;
            case RSSES:
                return PmParameterType.RSSES;
            case RSBBE:
                return PmParameterType.RSBBE;
            case RSUAS:
                return PmParameterType.RSUAS;
            case QVALUE:
                return PmParameterType.QVALUE;
            default:
     ...
     * @return dev
     */
    default org.opendaylight.yang.gen.v1.http.openconfig.net.yang.performance.types.rev200630.PmPointRef apiPmPointRefToDev(PmPointRef pmPointRef) {
        if (pmPointRef == null) {
            return null;
        }
    ...
    default org.opendaylight.yang.gen.v1.http.openconfig.net.yang.performance.types.rev200630.PmpObjectType apiPmpObjectTypeToDev(PmpObjectType pmpObjectType) {
        ...
        switch (pmpObjectType) {
            ...
            case SDH:
                return org.opendaylight.yang.gen.v1.http.openconfig.net.yang.performance.types.rev200630.PmpObjectType.SDH;
                default:
                throw NoMatchEnumValueException.getNoMatchEnumValueException(pmpObjectType);
        }
    }
    ...
    default org.opendaylight.yang.gen.v1.http.openconfig.net.yang.performance.types.rev200630.PmParameterType apiPmParameterTypeToDev(PmParameterType pmParameterType) {
        ...
        switch (pmParameterType) {
            ...
            case RSES:
                return org.opendaylight.yang.gen.v1.http.openconfig.net.yang.performance.types.rev200630.PmParameterType.RSES;
            case RSSES:
                return org.opendaylight.yang.gen.v1.http.openconfig.net.yang.performance.types.rev200630.PmParameterType.RSSES;
            case RSBBE:
                return org.opendaylight.yang.gen.v1.http.openconfig.net.yang.performance.types.rev200630.PmParameterType.RSBBE;
            case RSUAS:
                return org.opendaylight.yang.gen.v1.http.openconfig.net.yang.performance.types.rev200630.PmParameterType.RSUAS;
            case QVALUE:
                return org.opendaylight.yang.gen.v1.http.openconfig.net.yang.performance.types.rev200630.PmParameterType.QVALUE;
                default:
                throw NoMatchEnumValueException.getNoMatchEnumValueException(pmParameterType);
        }
    }
   ...
   default org.opendaylight.yang.gen.v1.http.openconfig.net.yang.performance.types.rev200630.PmRpcResult apiPmRpcResultToDev(PmRpcResult pmRpcResult){
    ...
    default PmDataValue devPmDataValueToApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.performance.rev200630.get.pm.data.output.performance.PmDataValue pmDataValue){
        ...
        if(pmDataValue instanceof Instant){
            ...
            BigDecimal digitalPmValue = ((Instant) pmDataValue).getDigitalPmValue().decimalValue();
            // 兼容II型机上报性能 值 pm-data-value
            if(digitalPmValue == null){
                digitalPmValue = ((Instant) pmDataValue).getPmDataValue().decimalValue();
            }
            ...
            if(new BigDecimal(digitalPmValue.longValue()).compareTo(digitalPmValue)==0){
                ...
                instantBuilder.setDigitalPmValue(Decimal64.valueOf(digitalPmValue));
                return instantBuilder.build();
            }else{
                //判断其为小数，则是判断设备数据上报错误
                InstantAvgMinMaxBuilder instantAvgMinMaxBuilder = new InstantAvgMinMaxBuilder();
                instantAvgMinMaxBuilder.setCurrentValue(Decimal64.valueOf(digitalPmValue));
