...
import org.opendaylight.yang.gen.v1.com.optel.dci.yang.platform.port.rev220208.PortConfig;
...
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.optical.amplifier.rev200630.*;
...
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.transport.types.rev200630.*;
...
public interface PortAndTransceiverAndOtdrAndOpticalChannelTypeTransform extends ITransform {
     ...
     * @return api速率
     */
    default ETHERNETSPEED devToChannelSpeedApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.ethernet.rev200630.ETHERNETSPEED clazz) {
        if (clazz == null) {
            return null;
        }
     ...
     * @return dev反转类型
     */
    default org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.port.rev200630.PortConfig.ReverseMode apiToReverseModeDev(PortConfig.ReverseMode reverseMode) {
        if (reverseMode == null) {
            return null;
        }
        switch (reverseMode) {
            case AUTO:
                return org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.port.rev200630.PortConfig.ReverseMode.AUTO;
            case NONE:
                return org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.port.rev200630.PortConfig.ReverseMode.NONE;
            case MANUAL:
                return org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.port.rev200630.PortConfig.ReverseMode.MANUAL;
            default:
     ...
     * @return api反转类型
     */
    default PortConfig.ReverseMode devToReverseModeApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.port.rev200630.PortConfig.ReverseMode reverseMode) {
        if (reverseMode == null) {
            return null;
        }
        switch (reverseMode) {
     ...
     * @return api
     */
    default Set<TRANSCEIVERPORTTYPE> devToUsedServicePortTypeApiList(Set<org.opendaylight.yang.gen.v1.http.openconfig.net.yang.transport.types.rev200630.TRANSCEIVERPORTTYPE> classList) {
        if (classList == null || classList.size() == 0) {
            return null;
        }
        Set<TRANSCEIVERPORTTYPE> list = new HashSet<>();
        for (org.opendaylight.yang.gen.v1.http.openconfig.net.yang.transport.types.rev200630.TRANSCEIVERPORTTYPE clazz : classList) {
     ...
     * @return dev
     */
    default org.opendaylight.yang.gen.v1.http.openconfig.net.yang.transport.types.rev200630.TRANSCEIVERPORTTYPE apiToUsedServicePortTypeDev(TRANSCEIVERPORTTYPE clazz) {
        if (clazz == null) {
            return null;
        }
     ...
     * @return api
     */
    default TRANSCEIVERPORTTYPE devToUsedServicePortTypeApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.transport.types.rev200630.TRANSCEIVERPORTTYPE clazz) {
        if (clazz == null) {
            return null;
        }
        Class<? extends org.opendaylight.yang.gen.v1.http.openconfig.net.yang.transport.types.rev200630.TRANSCEIVERPORTTYPE> lnc = clazz.implementedInterface();
     ...
     * @return api
     */
    default OtdrFileFormatType devToOtdrFileFormatTypeApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.otdr.rev200630.OtdrFileFormatType type) {
        if (type == null) {
            return null;
        }
        switch (type) {
     ...
     * @return api
     */
    default ActionResult devToActionResultApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.otdr.rev200630.ActionResult result) {
        if (result == null) {
            return null;
        }
        switch (result) {
     ...
     * @return api
     */
    default OtdrState.MeasuringState devToMeasuringStateApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.otdr.rev200630.OtdrState.MeasuringState state) {
        if (state == null) {
            return null;
        }
        switch (state) {
     ...
     * @return api
     */
    default OutputPower devToOutputPowerApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.transceiver.rev200630.optical.power.state.OutputPower outputPower) {
        if (outputPower == null) {
            return null;
        }
     ...
     * @return dev
     */
    default InputPower devToInputPowerApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.transceiver.rev200630.optical.power.state.InputPower inputPower) {
        if (inputPower == null) {
            return null;
        }
     ...
     * @return api
     */
    default OPTICALAMPLIFIERTYPE devToOpticalAmpTypeApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.optical.amplifier.rev200630.OPTICALAMPLIFIERTYPE clazz) {
        if (clazz == null) {
            return null;
        }
        Class<? extends org.opendaylight.yang.gen.v1.http.openconfig.net.yang.optical.amplifier.rev200630.OPTICALAMPLIFIERTYPE> lnc = clazz.implementedInterface();
     ...
     * @return dev
     */
    default org.opendaylight.yang.gen.v1.http.openconfig.net.yang.optical.amplifier.rev200630.OPTICALAMPLIFIERMODE apiToOpticalAmpTypeDev(OPTICALAMPLIFIERMODE clazz) {
        if (clazz == null) {
            return null;
        }
     ...
     * @return api
     */
    default OPTICALAMPLIFIERMODE devToOpticalAmpLifierModeApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.optical.amplifier.rev200630.OPTICALAMPLIFIERMODE clazz) {
        if (clazz == null) {
            return null;
        }
        Class<? extends org.opendaylight.yang.gen.v1.http.openconfig.net.yang.optical.amplifier.rev200630.OPTICALAMPLIFIERMODE> lnc = clazz.implementedInterface();
     ...
     * @return api
     */
    default TransportLineCommonPortState.MonType devToMonTypeApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.transport.line.common.rev200630.TransportLineCommonPortState.MonType monType) {
        if (monType == null) {
            return null;
        }
        switch (monType) {
    ...
    default org.opendaylight.yang.gen.v1.com.optel.dci.yang.transport.types.rev220208.OPTICALPORTTYPE devToOpticalPortType(OPTICALPORTTYPE clazz) {
        ...
        if (BI.class.equals(lnc) || org.opendaylight.yang.gen.v1.http.openconfig.net.yang.transport.line.common.rev200630.BI.class.equals(lnc)) {
            return org.opendaylight.yang.gen.v1.com.optel.dci.yang.transport.types.rev220208.BI.VALUE;
        } else if (INGRESS.class.equals(lnc) || org.opendaylight.yang.gen.v1.http.openconfig.net.yang.transport.line.common.rev200630.INGRESS.class.equals(lnc)) {
            return org.opendaylight.yang.gen.v1.com.optel.dci.yang.transport.types.rev220208.INGRESS.VALUE;
        } else if (EGRESS.class.equals(lnc) || org.opendaylight.yang.gen.v1.http.openconfig.net.yang.transport.line.common.rev200630.EGRESS.class.equals(lnc)) {
            return org.opendaylight.yang.gen.v1.com.optel.dci.yang.transport.types.rev220208.EGRESS.VALUE;
        } else if (ADD.class.equals(lnc) || org.opendaylight.yang.gen.v1.http.openconfig.net.yang.transport.line.common.rev200630.ADD.class.equals(lnc)) {
            return org.opendaylight.yang.gen.v1.com.optel.dci.yang.transport.types.rev220208.ADD.VALUE;
        } else if (DROP.class.equals(lnc) || org.opendaylight.yang.gen.v1.http.openconfig.net.yang.transport.line.common.rev200630.DROP.class.equals(lnc)) {
            return org.opendaylight.yang.gen.v1.com.optel.dci.yang.transport.types.rev220208.DROP.VALUE;
        } else if (MONITOR.class.equals(lnc) || org.opendaylight.yang.gen.v1.http.openconfig.net.yang.transport.line.common.rev200630.MONITOR.class.equals(lnc)) {
            return org.opendaylight.yang.gen.v1.com.optel.dci.yang.transport.types.rev220208.MONITOR.VALUE;
        } else if (org.opendaylight.yang.gen.v1.http.openconfig.net.yang.transport.types.rev200630.TERMINALCLIENT.class.equals(lnc)
                || org.opendaylight.yang.gen.v1.http.openconfig.net.yang.transport.line.common.rev200630.TERMINALCLIENT.class.equals(lnc)) {
            return org.opendaylight.yang.gen.v1.com.optel.dci.yang.transport.types.rev220208.TERMINALCLIENT.VALUE;
        } else if (org.opendaylight.yang.gen.v1.http.openconfig.net.yang.transport.types.rev200630.TERMINALLINE.class.equals(lnc)
                || org.opendaylight.yang.gen.v1.http.openconfig.net.yang.transport.line.common.rev200630.TERMINALLINE.class.equals(lnc)) {
     ...
     * @return api
     */
    default AvgMinMaxInstantStatsPrecision2DBm devToAvgMinMaxInstantStatsPrecisionApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.openconfig.types.rev200630.AvgMinMaxInstantStatsPrecision2DBm data) {
        if (data == null) {
            return null;
        }
        InputPowerBuilder builder = new InputPowerBuilder();
     ...
     * @return api
     */
    default AvgMinMaxInstantStatsPrecision2MA devToAvgMinMaxInstantStatsPrecisionApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.openconfig.types.rev200630.AvgMinMaxInstantStatsPrecision2MA data) {
        if (data == null) {
            return null;
        }
     ...
     * @return api
     */
    default AvgMinMaxInstantStatsPrecision2DB devToAvgMinMaxInstantStatsPrecisionApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.openconfig.types.rev200630.AvgMinMaxInstantStatsPrecision2DB data) {
        if (data == null) {
            return null;
        }
     ...
     * @return api
     */
    default Event.EventType devToEventTypeApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.otdr.rev200630.otdr.result.event.events.Event.EventType eventType) {
        if (eventType == null) {
            return null;
        }
        switch (eventType) {
