...
package com.optel.tmaster.dc.device.impl.dci.ctc.transform.telemetry;


import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import org.opendaylight.yang.gen.v1.com.optel.dci.yang.telemetry.rev220208.telemetry.data.*;
import org.opendaylight.yang.gen.v1.com.optel.dci.yang.telemetry.rev220208.telemetry.data.destination.groups.Destination;
...
import org.opendaylight.yang.gen.v1.com.optel.dci.yang.telemetry.rev220208.telemetry.data.destination.groups.DestinationKey;
...
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.DestinationGroups;
...
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.destination.groups.DestinationGroupBuilder;
...
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.destination.groups.destination.group.Destinations;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.destination.groups.destination.group.DestinationsBuilder;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.sensor.groups.SensorGroup;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.sensor.groups.SensorGroupKey;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.sensor.groups.sensor.group.includes.Include;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.sensor.groups.sensor.group.includes.IncludeKey;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.sensor.groups.sensor.group.sensor.paths.SensorPath;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.sensor.groups.sensor.group.sensor.paths.SensorPathBuilder;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.sensor.groups.sensor.group.sensor.paths.SensorPathKey;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.sensor.groups.sensor.group.sensor.paths.sensor.path.ConfigBuilder;
...
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.subscriptions.persistent.subscriptions.persistent.subscription.SensorProfiles;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.subscriptions.persistent.subscriptions.persistent.subscription.State;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.subscriptions.persistent.subscriptions.persistent.subscription.sensor.profiles.SensorProfile;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.subscriptions.persistent.subscriptions.persistent.subscription.sensor.profiles.SensorProfileBuilder;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.subscriptions.persistent.subscriptions.persistent.subscription.sensor.profiles.SensorProfileKey;
...
public class DciTelemetryTransform {
    ...
    private void devSensorGroupsToApi(SensorGroups sensorGroups, GetTelemetryOutputBuilder outputBuilder) {
        ...
        Map<SensorGroupKey, SensorGroup> sensorGroup = sensorGroups.getSensorGroup();
        if (CollUtil.isEmpty(sensorGroup)) {
            return;
        }
        Map<org.opendaylight.yang.gen.v1.com.optel.dci.yang.telemetry.rev220208.telemetry.data.SensorGroupKey, org.opendaylight.yang.gen.v1.com.optel.dci.yang.telemetry.rev220208.telemetry.data.SensorGroup> sensorGroupMap = new HashMap<>();
        for (SensorGroup sensorGroupValue : sensorGroup.values()) {
            SensorGroupBuilder sensorGroupBuilder = new SensorGroupBuilder();
            org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.sensor.groups.sensor.group.SensorPaths sensorPathObject = sensorGroupValue.getSensorPaths();
            if (null != sensorPathObject && CollUtil.isNotEmpty(sensorPathObject.getSensorPath())) {
                Map<SensorPathsKey, org.opendaylight.yang.gen.v1.com.optel.dci.yang.telemetry.rev220208.telemetry.data.sensor.group.SensorPaths> pathsMap = new HashMap<>();
            ...
            org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.sensor.groups.sensor.group.Includes includesObject = sensorGroupValue.getIncludes();
            if (null != includesObject && CollUtil.isNotEmpty(includesObject.getInclude())) {
                Map<IncludesKey, org.opendaylight.yang.gen.v1.com.optel.dci.yang.telemetry.rev220208.telemetry.data.sensor.group.Includes> includesMap = new HashMap<>();
            ...
            sensorGroupMap.put(new org.opendaylight.yang.gen.v1.com.optel.dci.yang.telemetry.rev220208.telemetry.data.SensorGroupKey(sensorGroupValue.getSensorGroupId()), sensorGroupBuilder.build());
        }
        outputBuilder.setSensorGroup(sensorGroupMap);
    }

    private void devDestinationGroupsToApi(DestinationGroups destinationGroups, GetTelemetryOutputBuilder outputBuilder) {
        ...
        Map<DestinationGroupsKey, org.opendaylight.yang.gen.v1.com.optel.dci.yang.telemetry.rev220208.telemetry.data.DestinationGroups> destinationGroupsMap = new HashMap<>();
        for (DestinationGroup groupValue : destinationGroup.values()) {
            ...
            if (destinations == null || CollUtil.isEmpty(destinations.getDestination())) {
                continue;
            }
            Map<org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.destination.groups.destination.group.destinations.DestinationKey, org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.destination.groups.destination.group.destinations.Destination> destination = destinations.getDestination();
            ...
            for (org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.destination.groups.destination.group.destinations.Destination value : destination.values()) {
    ...
    private void devSubscriptionsToApi(Subscriptions subscriptions, GetTelemetryOutputBuilder outputBuilder) {
        if (subscriptions == null || outputBuilder == null) {
            return;
        }
        ...
        if (CollUtil.isEmpty(persistentSubscription)) {
            return;
        }
        Map<PersistentSubscriptionKey, PersistentSubscription> subscriptionMap = new HashMap<>();
        for (org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.subscriptions.persistent.subscriptions.PersistentSubscription subscriptionValue : persistentSubscription.values()) {
            ...
            if (sensorProfiles != null) {
                ...
                if (CollUtil.isNotEmpty(sensorProfile)) {
                    ...
                    for (SensorProfile value : sensorProfile.values()) {
                        ...
                        org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.subscriptions.persistent.subscriptions.persistent.subscription.sensor.profiles.sensor.profile.State state = value.getState();
                        if (state != null) {
                            builder.setSensorGroup(state.getSensorGroup());
                            builder.setSampleInterval(state.getSampleInterval());
            ...
            org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.subscriptions.persistent.subscriptions.persistent.subscription.DestinationGroups destinationGroups = subscriptionValue.getDestinationGroups();
            if (destinationGroups != null) {
                ...
                if (CollUtil.isNotEmpty(destinationGroup)) {
                    ...
                    for (org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.subscriptions.persistent.subscriptions.persistent.subscription.destination.groups.DestinationGroup value : destinationGroup.values()) {
    ...
    public SensorGroup apiSensorGroupToDev(
            org.opendaylight.yang.gen.v1.com.optel.dci.yang.telemetry.rev220208.telemetry.data.SensorGroup sensorGroup) {
        if (null == sensorGroup) {
            return null;
        }
        org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.sensor.groups.SensorGroupBuilder groupBuilder = new org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.sensor.groups.SensorGroupBuilder();
        ...
        if (CollUtil.isNotEmpty(sensorPaths)) {
            org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.sensor.groups.sensor.group.SensorPathsBuilder sensorPathsBuilder = new org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.sensor.groups.sensor.group.SensorPathsBuilder();
            ...
            for (SensorPaths value : sensorPaths.values()) {
                ...
                ConfigBuilder configBuilder = new org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.sensor.groups.sensor.group.sensor.paths.sensor.path.ConfigBuilder();
        ...
        if (CollUtil.isNotEmpty(includes)) {
            org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.sensor.groups.sensor.group.IncludesBuilder includesBuilder = new org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.sensor.groups.sensor.group.IncludesBuilder();
            Map<IncludeKey, Include> map = new HashMap<>();
            for (Includes value : includes.values()) {
                org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.sensor.groups.sensor.group.includes.IncludeBuilder builder = new org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.sensor.groups.sensor.group.includes.IncludeBuilder();
                org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.sensor.groups.sensor.group.includes.include.ConfigBuilder configBuilder = new org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.sensor.groups.sensor.group.includes.include.ConfigBuilder();
        ...
        org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.sensor.groups.sensor.group.ConfigBuilder configBuilder = new org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.sensor.groups.sensor.group.ConfigBuilder();
    ...
    public DestinationGroup apiDestinationGroupsToDev(
            org.opendaylight.yang.gen.v1.com.optel.dci.yang.telemetry.rev220208.telemetry.data.DestinationGroups destinationGroups) {
        if (null == destinationGroups) {
            return null;
        }
        Map<DestinationKey, Destination> destination = destinationGroups.getDestination();
        ...
        Map<org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.destination.groups.destination.group.destinations.DestinationKey, org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.destination.groups.destination.group.destinations.Destination> map = new HashMap<>();
        for (org.opendaylight.yang.gen.v1.com.optel.dci.yang.telemetry.rev220208.telemetry.data.destination.groups.Destination value : destination.values()) {
            ...
            builder.setDestinationPort(value.getDestinationPort());
            map.put(new org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.destination.groups.destination.group.destinations.DestinationKey(ipAddress, value.getDestinationPort()), builder.build());
        }
    ...
    public org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.subscriptions.persistent.subscriptions.PersistentSubscription apiPersistentSubscriptionToDev(
            org.opendaylight.yang.gen.v1.com.optel.dci.yang.telemetry.rev220208.telemetry.data.PersistentSubscription subscription) {
        ...
        if (CollUtil.isNotEmpty(sensorProfiles)) {
            ...
            for (org.opendaylight.yang.gen.v1.com.optel.dci.yang.telemetry.rev220208.telemetry.data.persistent.subscription.SensorProfiles value : sensorProfiles.values()) {
                ...
                configBuilder.setSampleInterval(value.getSampleInterval());
        ...
        if (CollUtil.isNotEmpty(destinationGroups)) {
            ...
            for (org.opendaylight.yang.gen.v1.com.optel.dci.yang.telemetry.rev220208.telemetry.data.persistent.subscription.DestinationGroups value : destinationGroups.values()) {
                ...
                builder.setConfig(configBuilder.build());
                map.put(new org.opendaylight.yang.gen.v1.http.openconfig.net.yang.telemetry.rev200630.telemetry.top.telemetry.system.subscriptions.persistent.subscriptions.persistent.subscription.destination.groups.DestinationGroupKey(value.getGroupId()), builder.build());
            }
