...
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.transceiver.rev200630.port.transceiver.top.transceiver.ConfigBuilder;
...
public class DciTransceiverTransform implements PortAndTransceiverAndOtdrAndOpticalChannelTypeTransform {
    ...
    public org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.transceiver.rev200630.physical.channel.top.physical.channels.channel.Config apiToChannelDev(SetTransceiverChannelInput input){

        org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.transceiver.rev200630.physical.channel.top.physical.channels.channel.ConfigBuilder configBuilder=new org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.transceiver.rev200630.physical.channel.top.physical.channels.channel.ConfigBuilder();
