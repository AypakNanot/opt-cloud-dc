 ...
 */
package com.optel.tmaster.dc.device.impl.dci.ctc.transform.service;
...
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.tff.rev200630.Config1Builder;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.rpc.rev200630.GetOdukDelayInput;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.sdh.j0.top.SdhJ0Builder;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.sdh.j0.top.sdh.j0.SdhJ0ConfigBuilder;
...
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.terminal.logical.channel.top.LogicalChannelsBuilder;
...
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.terminal.logical.channel.top.logical.channels.ChannelBuilder;
...
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.terminal.otn.protocol.top.otn.ConfigBuilder;
...
public class ServiceTransformImpl implements PlatformTypeTransform, CommonTypeTransform {
    ...
    public org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.mux.rev200630.frequency.config.FrequencyChannel apiToFrequencyChannelDev(FrequencyChannelsConfig input) {
        org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.mux.rev200630.frequency.config.FrequencyChannelBuilder builder = new org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.mux.rev200630.frequency.config.FrequencyChannelBuilder();
    ...
    public org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.wss.rev200630.Config1 apiToFrequencyChannelsDev(BatchSetWssFrequencyChannelsInput input) {
        org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.wss.rev200630.Config1Builder builder = new org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.wss.rev200630.Config1Builder();
        Map<org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.mux.rev200630.frequency.config.FrequencyChannelKey, org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.mux.rev200630.frequency.config.FrequencyChannel> values = new HashMap<>();
        Objects.requireNonNull(input.getFrequencyChannel()).forEach((key, frequencyChannel) -> {
            org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.mux.rev200630.frequency.config.FrequencyChannelBuilder frequencyChannelBuilder = new org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.mux.rev200630.frequency.config.FrequencyChannelBuilder();
    ...
    public GetTerminalDeviceOutput devTerminalDeviceToApi(TerminalDevice terminalDevice){
        ...
        try {
//            log.info("ctc devTerminalDeviceToApi ServiceTransformImpl, {}", JSON.toJSONString(outputBuilder));
        } catch (Exception e) {
            log.error("print ctc devTerminalDeviceToApi ServiceTransformImpl log error", e);
        }
    ...
    public GetOperationalModesOutput devToGetOperationalModesOutputApi(
            org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.terminal.operational.mode.top.OperationalModes operationalModes, Set<Uint16> modeIds){
    ...
    public Map<OperationalModesKey, OperationalModes> devToOperationalModesApi(
        ...
        for (org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.terminal.operational.mode.top.operational.modes.Mode mode : operationalModes.getMode().values()) {
    ...
    private OperationalModes devToModeApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.terminal.operational.mode.top.operational.modes.Mode mode) {
    ...
    public Ingress devChannelIngressToApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.terminal.logical.channel.ingress.top.Ingress ingress) {
    ...
    public org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.terminal.logical.channel.top.logical.channels.Channel apiToChannelDev(SetLogicalChannelInput input){
        org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.terminal.logical.channel.top.logical.channels.ChannelBuilder channelBuilder = new ChannelBuilder();

        org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.terminal.logical.channel.top.logical.channels.channel.ConfigBuilder channelConfigBuilder = new org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.terminal.logical.channel.top.logical.channels.channel.ConfigBuilder();
        channelConfigBuilder.setAdminState(apiAdminStateTypeToDev(input.getAdminState()));
        channelConfigBuilder.setDelayTestMode(apiToDelayTestModeDevString(input.getDelayTestMode()));
        ...
        if (Objects.nonNull(otn)) {
            // 电层OTU业务通道TTI开销配置
            org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.terminal.otn.protocol.top.OtnBuilder otnBuilder = new org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.terminal.otn.protocol.top.OtnBuilder();
    ...
    private Map<LogicalChannelAssignmentsKey, LogicalChannelAssignments> devLogicalAssignmentToApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.terminal.logical.chan.assignment.top.LogicalChannelAssignments assignments) {
        ...
        for (org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.terminal.logical.chan.assignment.top.logical.channel.assignments.Assignment assignment : assignments.getAssignment().values()) {
    ...
    public GetOtnProtocolOutput devToGetOtnProtocolOutputApi(Channel channel) {
        ...
        builder.setBbe(channel.getOtn().getState().getBbe());
        builder.setBber(channel.getOtn().getState().getBber());
        builder.setEs(channel.getOtn().getState().getEs());
        builder.setEsnr(devToEsnrApi(channel.getOtn().getState().getEsnr()));
        builder.setFebbe(channel.getOtn().getState().getFebbe());
        builder.setFebber(channel.getOtn().getState().getFebber());
        builder.setFees(channel.getOtn().getState().getFees());
        builder.setFeses(channel.getOtn().getState().getFeses());
        builder.setFesesr(channel.getOtn().getState().getFesesr());
        builder.setFeuas(channel.getOtn().getState().getFeuas());
        ...
        builder.setSes(channel.getOtn().getState().getSes());
        builder.setSesr(channel.getOtn().getState().getSesr());
        ...
        builder.setUas(channel.getOtn().getState().getUas());
        builder.setTtiMsgTransmit(channel.getOtn().getState().getTtiMsgTransmit());
        builder.setTtiMsgExpected(channel.getOtn().getState().getTtiMsgExpected());
        builder.setTtiMsgRecv(channel.getOtn().getState().getTtiMsgRecv());
        return builder.build();
    ...
    private QValue devToQValueApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.terminal.otn.protocol.multi.stats.QValue qValue) {
        if(qValue == null){
            return null;
        }
    ...
    private PreFecBer devToPreFecBerApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.terminal.otn.protocol.multi.stats.PreFecBer preFecBer) {
        if(preFecBer == null){
            return null;
        }
    ...
    private PostFecBer devToPostFecBerApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.terminal.otn.protocol.multi.stats.PostFecBer postFecBer) {
        if(postFecBer == null){
            return null;
        }
    ...
    private Esnr devToEsnrApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.terminal.otn.protocol.multi.stats.Esnr esnr) {
        if(esnr == null){
            return null;
        }
        ...
        if (channel.getEthernet().getLldp() != null) {
            ...
            if (channel.getEthernet().getLldp().getState() != null) {
                if (channel.getEthernet().getLldp().getState().getCounters() != null) {
                    ...
                    countersBuilder.setFrameDiscard(channel.getEthernet().getLldp().getState().getCounters().getFrameDiscard());
                    countersBuilder.setFrameErrorIn(channel.getEthernet().getLldp().getState().getCounters().getFrameErrorIn());
                    countersBuilder.setFrameErrorOut(channel.getEthernet().getLldp().getState().getCounters().getFrameErrorOut());
                    countersBuilder.setFrameIn(channel.getEthernet().getLldp().getState().getCounters().getFrameIn());
                    countersBuilder.setFrameOut(channel.getEthernet().getLldp().getState().getCounters().getFrameOut());
                    countersBuilder.setLastClear(channel.getEthernet().getLldp().getState().getCounters().getLastClear());
                    countersBuilder.setTlvDiscard(channel.getEthernet().getLldp().getState().getCounters().getTlvDiscard());
                    countersBuilder.setTlvUnknown(channel.getEthernet().getLldp().getState().getCounters().getTlvUnknown());
    ...
    public GetOdukDelayInput apiToGetOdukDelayInputDev(org.opendaylight.yang.gen.v1.com.optel.device.opt.dci.service.rev200210.GetOdukDelayInput input){
        if(input==null){
            return null;
        }
        org.opendaylight.yang.gen.v1.http.openconfig.net.yang.rpc.rev200630.GetOdukDelayInputBuilder builder=new org.opendaylight.yang.gen.v1.http.openconfig.net.yang.rpc.rev200630.GetOdukDelayInputBuilder();
        builder.setIndex(input.getIndex());
        builder.setDelayTestTimes(input.getDelayTestTimes());
        return builder.build();
    }
    public GetOdukDelayOutput devToGetOdukDelayOutputApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.rpc.rev200630.GetOdukDelayOutput odukDelayOutput){
    ...
    private DelayDataValue devToDelayDataValueApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.rpc.rev200630.get.oduk.delay.output.DelayDataValue dataValue){
        if(dataValue==null){
            return null;
        }
    ...
    private Neighbors devToNeighborsApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.lldp.logical.channel.neighbor.top.Neighbors neighbors) {
        if(neighbors == null){
            return null;
        }
        ...
        for (org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.lldp.logical.channel.neighbor.top.neighbors.Neighbor neighbor : neighbors.getNeighbor().values()) {
            ...
            if (neighbor.getCustomTlvs() != null) {
                if (neighbor.getCustomTlvs().getTlv() != null) {
                    ...
                    for (org.opendaylight.yang.gen.v1.http.openconfig.net.yang.lldp.rev181121.lldp.custom.tlv.top.custom.tlvs.Tlv tlv : neighbor.getCustomTlvs().getTlv().values()) {
   ...
   public LogicalChannels apiToLogicalChannels(BatchSetLogicalChannelInput input){
       ...
       for(LogicalChannelConfig channelConfig:input.getLogicalChannelConfig()){
           ...
           org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.terminal.logical.channel.top.logical.channels.channel.ConfigBuilder configBuilder=new org.opendaylight.yang.gen.v1.http.openconfig.net.yang.terminal.device.rev200630.terminal.logical.channel.top.logical.channels.channel.ConfigBuilder();
