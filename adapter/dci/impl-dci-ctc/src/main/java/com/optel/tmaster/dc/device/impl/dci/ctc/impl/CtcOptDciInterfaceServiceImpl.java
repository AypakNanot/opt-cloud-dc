...
import com.optel.tmaster.dc.device.impl.dci.ctc.transform.config.DciInterfaceTransform;
...
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.ip.rev200630.ipv4.top.Ipv4;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.interfaces.ip.rev200630.ipv4.top.ipv4.Addresses;
 ...
 * 2022/3/9 15:10
 */
public class CtcOptDciInterfaceServiceImpl extends BaseDciInterfaceImpl implements IDeviceServiceWdmCtc {
    /**
    ...
    public ListenableFuture<RpcResult<GetInterfaceOutput>> getInterface(GetInterfaceInput input) {
        Interfaces interfaces = getInterfaces(input.getNeId(), input.getName());
...
//                .augmentation(Config1.class);
    ...
    public ListenableFuture<RpcResult<SetDcnInterfaceOutput>> setDcnInterface(SetDcnInterfaceInput input) {
        ...
        if (input.getOspfEnabled() != null) {
            MountTools.doMergeToConfig(input.getNeId(), configIid, dciInterfaceTransform.apiToConfigDev(input.getOspfEnabled()));
        }
