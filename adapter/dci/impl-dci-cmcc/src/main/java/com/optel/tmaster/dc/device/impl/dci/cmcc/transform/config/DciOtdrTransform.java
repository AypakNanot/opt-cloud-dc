...
import org.opendaylight.yang.gen.v1.urn.cmcc.yang.otdr.rev230426.otdr.result.event.Events;
import org.opendaylight.yang.gen.v1.urn.cmcc.yang.otdr.rev230426.otdr.top.Otdrs;
import org.opendaylight.yang.gen.v1.urn.cmcc.yang.otdr.rev230426.otdr.top.otdrs.otdr.ConfigBuilder;
...
public class DciOtdrTransform implements PortAndTransceiverAndOtdrAndOpticalChannelTypeTransform {
    ...
    public org.opendaylight.yang.gen.v1.urn.cmcc.yang.otdr.rev230426.StartOtdrInput apiToStartOtdrInputDev(StartOtdrInput input) {
        org.opendaylight.yang.gen.v1.urn.cmcc.yang.otdr.rev230426.StartOtdrInputBuilder builder = new org.opendaylight.yang.gen.v1.urn.cmcc.yang.otdr.rev230426.StartOtdrInputBuilder();
    ...
    public StartOtdrOutput devToStartOtdrOutputApi(org.opendaylight.yang.gen.v1.urn.cmcc.yang.otdr.rev230426.StartOtdrOutput otdrOutput) {
    ...
    public org.opendaylight.yang.gen.v1.urn.cmcc.yang.otdr.rev230426.StopOtdrInput apiToStopOtdrOutputDev(StopOtdrInput input) {
        org.opendaylight.yang.gen.v1.urn.cmcc.yang.otdr.rev230426.StopOtdrInputBuilder builder = new org.opendaylight.yang.gen.v1.urn.cmcc.yang.otdr.rev230426.StopOtdrInputBuilder();
        builder.setName(input.getName());
        return builder.build();
    }
    ...
    public GetOtdrConfigOutput devToGetOtdrConfigOutputApi(Otdrs otdrs) {
        ...
        if (otdrs.getOtdr() != null && otdrs.getOtdr().size() != 0) {
            ...
            for (Map.Entry<org.opendaylight.yang.gen.v1.urn.cmcc.yang.otdr.rev230426.otdr.top.otdrs.OtdrKey, org.opendaylight.yang.gen.v1.urn.cmcc.yang.otdr.rev230426.otdr.top.otdrs.Otdr> otdrEntry : otdrs.getOtdr().entrySet()) {
    ...
    public GetOtdrResultOutput devToGetOtdrResultOutputApi(org.opendaylight.yang.gen.v1.urn.cmcc.yang.otdr.rev230426.otdr.top.otdrs.Otdr otdr) {
        ...
        if (otdr.getResults() != null && otdr.getResults().getResult() != null && otdr.getResults().getResult().size() != 0) {
            for (Map.Entry<org.opendaylight.yang.gen.v1.urn.cmcc.yang.otdr.rev230426.otdr.result.top.results.ResultKey, org.opendaylight.yang.gen.v1.urn.cmcc.yang.otdr.rev230426.otdr.result.top.results.Result> result : otdr.getResults().getResult().entrySet()) {
                ...
                resultBuilder.setDetectTime(new DateAndTime(result.getValue().getDetectTime().getValue()));
    ...
    public GetOtdrResultEventOutput devToGetOtdrResultEventOutputApi(org.opendaylight.yang.gen.v1.urn.cmcc.yang.otdr.rev230426.otdr.result.top.results.Result result){
        ...
        for(org.opendaylight.yang.gen.v1.urn.cmcc.yang.otdr.rev230426.otdr.result.event.events.Event event:events.getEvent().values()){
    ...
    public org.opendaylight.yang.gen.v1.urn.cmcc.yang.otdr.rev230426.otdr.top.otdrs.otdr.Config apiToOtdrDev(SetOtdrConfigInput input) {
        org.opendaylight.yang.gen.v1.urn.cmcc.yang.otdr.rev230426.otdr.top.otdrs.otdr.ConfigBuilder configBuilder = new ConfigBuilder();
