...
import org.opendaylight.yang.gen.v1.com.optel.dci.yang.system.rev220208.system.ntp.server.top.servers.ServerBuilder;
import org.opendaylight.yang.gen.v1.com.optel.device.opt.dci.ne.time.rev200210.*;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.system.rev230426.system.ntp.server.top.servers.Server;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.system.rev230426.system.ntp.server.top.servers.ServerKey;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.system.rev230426.system.ntp.server.top.servers.server.ConfigBuilder;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.system.rev230426.system.ntp.top.Ntp;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.system.rev230426.system.top.system.State;
...
public class DciNeTimeTransform implements GeneralUtilTransform {
    ...
    public QueryMeNtpOutput devQueryMeNtpOutputToApi(Ntp ntp) {
        ...
        serverDevMap.forEach((key, value) -> {
            ...
            var valueBuilder = new ServerBuilder();
     ...
     * @return dev
     */
    public org.opendaylight.yang.gen.v1.http.openconfig.net.yang.system.rev230426.system.ntp.server.top.servers.Server apiAddModifyMeNtpInputToDev(AddModifyMeNtpInput input) {
        if (input == null) {
            return null;
        }
        org.opendaylight.yang.gen.v1.http.openconfig.net.yang.system.rev230426.system.ntp.server.top.servers.ServerBuilder serverBuilder = new org.opendaylight.yang.gen.v1.http.openconfig.net.yang.system.rev230426.system.ntp.server.top.servers.ServerBuilder();
    ...
    public GetNeTimeOutput devGetNeTimeOutputToApi(State sysState) {
        ...
        getNeTimeOutputBuilder.setDatetime(new DateAndTime(sysState.getCurrentDatetime().getValue()));
