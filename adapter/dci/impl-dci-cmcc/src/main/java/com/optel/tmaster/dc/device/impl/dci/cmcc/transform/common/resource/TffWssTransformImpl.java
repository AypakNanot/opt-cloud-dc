...
//    }
    ...
    private Map<FrequencyChannelKey, FrequencyChannel> devToFrequencyChannelMapApi(Map<org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.mux.rev230426.frequency.state.FrequencyChannelKey,
            org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.mux.rev230426.frequency.state.FrequencyChannel> channels) {
        if(channels == null){
            return null;
        }
        Map<FrequencyChannelKey, FrequencyChannel> channelMap = new HashMap<>(channels.size());
        for (org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.mux.rev230426.frequency.state.FrequencyChannel channel : channels.values()) {
    ...
    //极简OTN 没有WSS
//    public Wss devWssToApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.rev230426.platform.anchors.top.Wss wss){
//        if(wss == null || wss.getState() == null){
//            return null;
//        }
//        org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.wss.rev200630.@Nullable State1 state1 = wss.getState().augmentation(State1.class);
//        if(state1 == null){
//            return null;
//        }
