...
import com.optel.tmaster.dc.device.impl.dci.cmcc.transform.config.DciEdfaTransform;
...
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.optical.amplifier.rev230426.optical.amplifier.top.OpticalAmplifier;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.optical.amplifier.rev230426.optical.amplifier.top.optical.amplifier.Amplifiers;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.optical.amplifier.rev230426.optical.amplifier.top.optical.amplifier.amplifiers.Amplifier;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.optical.amplifier.rev230426.optical.amplifier.top.optical.amplifier.amplifiers.AmplifierKey;
 ...
 * @since 2022/3/8
 **/
public class CmccOptEdfaServiceImpl extends BaseDciEdfaImpl implements IDeviceServiceWdmCmcc {
    ...
    public ListenableFuture<RpcResult<GetEdfaConfigOutput>> getEdfaConfig(GetEdfaConfigInput input) {
        ...
        OpticalAmplifier opticalAmplifier = null;
        if (Boolean.valueOf(property)) {
//            opticalAmplifier= new TestData().getOpticalAmplifier();
        } else {
            opticalAmplifier = MountTools.queryFromOperational(input.getNeId(), identifier);
        }
