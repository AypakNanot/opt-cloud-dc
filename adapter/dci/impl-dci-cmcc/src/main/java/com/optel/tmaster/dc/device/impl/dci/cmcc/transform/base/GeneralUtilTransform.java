...
import org.opendaylight.yang.gen.v1.com.optel.dci.yang.types.inet.rev220208.*;
...
public interface GeneralUtilTransform extends ITransform {
     ...
     * @return api
     */
    default PortNumber devPortNumberToApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.types.inet.rev190425.PortNumber portNumber) {
        if (portNumber == null) {
            return null;
        }
        return new PortNumber(portNumber.getValue());
    }
     ...
     * @return dev
     */
    default org.opendaylight.yang.gen.v1.http.openconfig.net.yang.types.inet.rev190425.PortNumber apiPortNumberToDev(PortNumber portNumber) {
        if (portNumber == null) {
            return null;
        }
     ...
     * @return api mac
     */
    default MacAddress devMacAddressToApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.types.yang.rev181121.MacAddress macAddress) {
        if (macAddress == null) {
            return null;
        }
     ...
     * @return api
     */
    default Ipv4Address devIpv4AddressToApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.types.inet.rev190425.Ipv4Address ipv4Address) {
        if (ipv4Address == null) {
            return null;
        }
     ...
     * @return dev
     */
    default org.opendaylight.yang.gen.v1.http.openconfig.net.yang.types.inet.rev190425.Ipv4Address apiIpv4AddressToDev(Ipv4Address ipv4Address) {
        if (ipv4Address == null) {
            return null;
        }
        return new org.opendaylight.yang.gen.v1.http.openconfig.net.yang.types.inet.rev190425.Ipv4Address(ipv4Address.getValue());
    }
     ...
     * @return api
     */
    default Host devHostToApi(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.types.inet.rev190425.Host host) {
        if (host == null) {
            return null;
        }
        ...
        IpAddress address;
        if (ipAddress != null) {
            address = new IpAddress(devIpv4AddressToApi(ipAddress.getIpv4Address()));
            return new Host(address);
        }
        DomainName domainName1;
        if (domainName != null) {
            domainName1 = new DomainName(domainName.getValue());
            return new Host(domainName1);
        }
     ...
     */
    //极简OTN没有邻居IP
//    default NeighborIpType apiSetNeighbourIpInputToDev(SetNeighbourIpInputGrouping.NeighborIpType neighbourIpType) {
//        if (neighbourIpType == null) {
//            return null;
//        }
//        switch (neighbourIpType) {
//            case NM:
//                return SetNeighborIpInput.NeighborIpType.NM;
//            case OSC:
//                return SetNeighborIpInput.NeighborIpType.OSC;
//            case LOOPBACK:
//                return SetNeighborIpInput.NeighborIpType.LOOPBACK;
//            default:
