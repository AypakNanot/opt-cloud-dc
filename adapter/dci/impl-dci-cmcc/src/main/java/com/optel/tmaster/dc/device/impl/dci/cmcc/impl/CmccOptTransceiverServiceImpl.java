...
import com.optel.tmaster.dc.device.impl.dci.cmcc.transform.config.DciTransceiverTransform;
...
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.transceiver.rev230426.Component1;
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.transceiver.rev230426.physical.channel.top.PhysicalChannels;
...
import org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.transceiver.rev230426.port.transceiver.top.Transceiver;
 ...
 * @since 2022/3/4
 **/
public class CmccOptTransceiverServiceImpl extends BaseDciTransceiverImpl implements IDeviceServiceWdmCmcc {
    @Override
    ...
    public ListenableFuture<RpcResult<SetTransceiverChannelOutput>> setTransceiverChannel(SetTransceiverChannelInput input) {
        @NonNull InstanceIdentifier<org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.transceiver.rev230426.physical.channel.top.physical.channels.channel.Config> child = create(Components.class).child(Component.class, new ComponentKey(input.getName())).augmentation(Component1.class).child(Transceiver.class).child(PhysicalChannels.class).child(Channel.class, new ChannelKey(input.getIndex())).child(org.opendaylight.yang.gen.v1.http.openconfig.net.yang.platform.transceiver.rev230426.physical.channel.top.physical.channels.channel.Config.class);
