 ...
 * @version V1.0.0
 */
public class SnmpAsyncSetHandler implements ResponseListener {
    private static final Logger LOG = LoggerFactory.getLogger(SnmpAsyncSetHandler.class);
    ...
    public SnmpAsyncSetHandler(SnmpSetInput input, Snmp snmp) {
        snmp4j = snmp;
        snmpSetInput = input;
        target = SnmpRequestUtil.getTargetForIp(input);
    ...
    private void sendSnmpSet() {
        try {
            ...
            rpcResultBuilder.withError(ErrorType.APPLICATION, e.getMessage());
            ...
            if (errorStatus != PDU.noError) {
                ...
                if (errorStatus == PDU.wrongType) {
                    ...
                    try {
                        ...
                        rpcResultBuilder.withError(ErrorType.APPLICATION, "SnmpSET failed. Unknown object set type");
                    }
                    ...
                    rpcResultBuilder = RpcResultBuilder.failed();
                    rpcResultBuilder.withError(ErrorType.APPLICATION,
