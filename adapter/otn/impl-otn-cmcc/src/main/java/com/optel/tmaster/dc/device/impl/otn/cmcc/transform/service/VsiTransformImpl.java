...
import org.opendaylight.yang.gen.v1.com.optel.devconf.opt.connection.rev200427.AddVsiNniMemberNeOutputBuilder;
...
import org.opendaylight.yang.gen.v1.com.optel.devconf.opt.connection.rev200427.GetVsiMemberAttrNeOutputBuilder;
...
import org.opendaylight.yang.gen.v1.com.optel.devconf.opt.connection.rev200427.QueryVsiOutputBuilder;
...
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.AddVcgPathInput;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.AddVcgPathInputBuilder;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.AddVcgPathOutput;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.LearningMode;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.UnknownFrameProcess;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.Vsis;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.get.vsi.member.attr.out.grouping.VsiMemberAttr;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.uni.grouping.ClientVlanSpec;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.uni.grouping.ClientVlanSpecBuilder;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.uni.grouping.EgressCapacity;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.uni.grouping.EgressCapacityBuilder;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.uni.grouping.IngressCapacity;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.uni.grouping.IngressCapacityBuilder;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.uni.grouping.UniVlanSpec;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.uni.grouping.UniVlanSpecBuilder;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.vsis.grouping.VsiBuilder;
...
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.devm.rev200708.AdminState;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.devm.rev200708.ServiceType;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.nni.grouping.EosPac;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.nni.grouping.LcasAttr;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.nni.grouping.MultiNniPac;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.nni.grouping.MultiSecondaryNni;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.nni.grouping.MultiSvlanAttr;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.nni.grouping.PrimaryNni;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.nni.grouping.SecondaryNni;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eth.rev200611.EthMappingType;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.protection.group.rev200708.ProtectionType;
...
public class VsiTransformImpl  extends ConnectionEosTransformImpl  {
    ...
    public QueryVsiOutput devQueryVsiToApi(Vsis vsis){
        ...
        if(vsis.getVsi() != null){
            ...
            for(org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.vsis.grouping.Vsi vsi:vsis.getVsi().values()){
    ...
    public org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.vsis.grouping.Vsi apiModifyVsiInputToDev(ModifyVsiInput input){
        VsiBuilder vsiBuilder = new VsiBuilder();
        vsiBuilder.withKey(new org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.vsis.grouping.VsiKey(input.getName()));
     ...
     */
    public org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.AddVsiNniMemberInput
            apiAddVsiNniMemberToDev(AddVsiNniMemberNeInput input){
        org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.NniGrouping nniGrouping = apiNniGroupingToDev(input);
        if(nniGrouping == null){
            return null;
        }
        org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.AddVsiNniMemberInputBuilder builder
                = new org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.AddVsiNniMemberInputBuilder(nniGrouping);
        builder.setName(input.getName());
        return builder.build();
    }

    public AddVsiNniMemberNeOutput
            devAddVsiNniMemberOutputToDev(org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.AddVsiNniMemberOutput output){
        if(output == null){
            return null;
        }
    ...
    public org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.DeleteVsiMemberInput
            apiDeleteVsiMemberInput(DeleteVsiMemberNeInput input){
        if(input == null){
            return null;
        }
        org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.DeleteVsiMemberInputBuilder builder
                = new org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.DeleteVsiMemberInputBuilder();
    ...
    public AddVcgPathInput apiAddVcgPathInputToDev(AddVcgPathNeInput input){
        ...
        builder.setVcType(apiSwitchTypeToDev(input.getVcType()));
    ...
    protected org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.NniGrouping apiNniGroupingToDev(NniGrouping nniGrouping){
        if(nniGrouping == null){
            return null;
        }
        return new org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.NniGrouping() {
            ...
            @Override
            public Class<? extends org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.NniGrouping> implementedInterface() {
                return null;
            }
    ...
    protected org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.UniGrouping apiUniGroupingToDev(UniGrouping uniGrouping){
        if(uniGrouping == null){
            return null;
        }
        return new org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.UniGrouping() {
            @Override
            public Class<? extends org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.UniGrouping> implementedInterface() {
                return null;
            }
    ...
    protected org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.BasicParamGrouping apiBasicParamGroupingToDev(BasicParamGrouping basicParamGrouping){
        if(basicParamGrouping == null){
            return null;
        }
        return new org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.BasicParamGrouping() {
            @Override
            public Class<? extends org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.BasicParamGrouping> implementedInterface() {
                return null;
            }
    ...
    public VsiGrouping devVsiToApi(org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.VsiGrouping vsi){
        if(vsi == null){
            return null;
        }
        return new VsiGrouping() {
            ...
            @Override
            public @Nullable Set<String> getUniCtp() {
                return vsi.getUniCtp();
            }

            @Override
            public @Nullable Set<String> getNniCtp() {
    ...
    public CreateComponent devCreateComponentToApi (
            org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.add.vsi.nni.member.out.grouping.CreateComponent createComponent){
    ...
    public org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.AddVsiUniMemberInput
            apiAddVsiUniMemberToDev(AddVsiUniMemberNeInput input){
        org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.UniGrouping uniGrouping
                = apiUniGroupingToDev(input);
        if(uniGrouping==null){
            return null;
        }
        org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.AddVsiUniMemberInputBuilder builder
                = new org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.AddVsiUniMemberInputBuilder(uniGrouping);
        builder.setName(input.getName());
    ...
    public AddVsiUniMemberNeOutput
            devAddVsiUniMemberToApi(org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.AddVsiUniMemberOutput output){
        if(output==null){
            return null;
        }
    ...
    public org.opendaylight.yang.gen.v1.com.optel.devconf.opt.connection.rev200427.GetVsiMemberAttrNeOutput
            devGetVsiMemberAttrToApi(org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.GetVsiMemberAttrOutput output){
        if(output==null){
            return null;
        }
    ...
    public List<org.opendaylight.yang.gen.v1.com.optel.yang.api.otn.extension.rev210927.get.vsi.member.attr.out.grouping.VsiMemberAttr>
            devVsiMemberAttrToApiList(Map<org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.get.vsi.member.attr.out.grouping.VsiMemberAttrKey, VsiMemberAttr> list){
        ...
        for(org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.get.vsi.member.attr.out.grouping.VsiMemberAttr e : list.values()){
    ...
    public org.opendaylight.yang.gen.v1.com.optel.yang.api.otn.extension.rev210927.get.vsi.member.attr.out.grouping.VsiMemberAttr
            devVsiMemberAttrToApi(org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.get.vsi.member.attr.out.grouping.VsiMemberAttr e){
        if(e==null){
            return null;
        }
