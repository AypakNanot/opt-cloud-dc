...
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.devm.rev200708.AccDevmService;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.devm.rev200708.GetManagedElementTimeInputBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.devm.rev200708.GetManagedElementTimeOutput;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.devm.rev200708.SetManagedElementTimeInputBuilder;
import org.opendaylight.yangtools.yang.common.RpcResult;

import java.util.concurrent.Future;

/**
 * dc-aggregator - CmccOptNeTimeServiceImpl
 * 网元时间配置
 * date       time        author
 * ─────────────────────────────
 ...
 * @version V1.0.0
 */
public class CmccOptNeTimeServiceImpl extends BaseOptNeTimeServiceImpl implements IDeviceServiceOtnCmcc {
    @Override
