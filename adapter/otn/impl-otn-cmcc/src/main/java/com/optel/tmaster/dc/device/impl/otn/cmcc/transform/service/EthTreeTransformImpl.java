...
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.BasicParamGrouping;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.CreateEthTreeServiceInput;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.CreateEthTreeServiceInputBuilder;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.CreateEthTreeServiceOutput;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.create.eth.tree.service.in.grouping.NnisBuilder;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.create.eth.tree.service.in.grouping.NnisKey;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.create.eth.tree.service.in.grouping.UnisBuilder;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.create.eth.tree.service.in.grouping.UnisKey;
...
public class EthTreeTransformImpl extends VsiTransformImpl {
    ...
    public CreateEthTreeServiceInput apiCreateTreeInputToDev(CreateEthTreeServiceNeInput input){
        ...
        if(input.getUnis() != null){
            List<org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.create.eth.tree.service.in.grouping.Unis> devUnis = new ArrayList<>();
        ...
        if(input.getNnis() != null){
            List<org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.create.eth.tree.service.in.grouping.Nnis> devNnis = new ArrayList<>();
