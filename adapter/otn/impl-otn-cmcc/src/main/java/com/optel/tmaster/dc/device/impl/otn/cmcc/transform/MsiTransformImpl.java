 ...
 * 2021/10/9 14:37
 */
public class MsiTransformImpl extends AbstractCmccTransformer implements CommonTransform, EnumTransform {

    public List<MsiAutoParameter> devMsiAutoToApiList (List<org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.msi.auto.parameter.grouping.MsiAutoParameter> msiAutoParameters){
        if(msiAutoParameters == null){
            return null;
        }
        List<MsiAutoParameter> res = new ArrayList<>();
        for(org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.msi.auto.parameter.grouping.MsiAutoParameter msiAutoParameter: msiAutoParameters){
            res.add(devMsiAutoToApi(msiAutoParameter).build());
        }
        return res;
    }

    public MsiAutoParameterBuilder devMsiAutoToApi(org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.msi.auto.parameter.grouping.MsiAutoParameter msiAutoParameter){
    ...
    public List<MsiParameter> devMsiParameterToApiList (List<org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.msi.parameter.grouping.MsiParameter> msiParameters){
        if(msiParameters == null){
            return null;
        }
        List<MsiParameter> res = new ArrayList<>();
        for(org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.msi.parameter.grouping.MsiParameter msiParameter : msiParameters){
            res.add(devMsiParameterToApi(msiParameter).build());
        }
        return res;
    }

    public MsiParameterBuilder devMsiParameterToApi(org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.msi.parameter.grouping.MsiParameter msiParameter){
