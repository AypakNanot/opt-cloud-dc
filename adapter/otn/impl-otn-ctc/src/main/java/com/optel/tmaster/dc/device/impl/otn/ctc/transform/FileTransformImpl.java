 ...
 * @version V1.0.0
 */
public class FileTransformImpl extends AbstractCtcTransformer implements CommonTransform, EnumTransform {
    ...
    public GetFileListNeOutput devGetFileListToApi(
        ...
        return getFileListNeOutputBuilder.build();
    }
