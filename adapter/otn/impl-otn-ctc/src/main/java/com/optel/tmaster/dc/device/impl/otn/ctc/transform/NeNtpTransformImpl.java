...
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.devm.rev240702.MeBuilder;
 ...
 * @since 2021/10/14
 **/
public class NeNtpTransformImpl extends AbstractCtcTransformer implements CommonTransform, EnumTransform, ServiceTransform {
    public NtpServerBuilder apiNtpServerToDev(AddModifyMeNtpInput input){
        org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.devm.rev240702.me.ntp.servers.NtpServerBuilder ntpServerBuilder=new org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.devm.rev240702.me.ntp.servers.NtpServerBuilder();
        if(input==null){
