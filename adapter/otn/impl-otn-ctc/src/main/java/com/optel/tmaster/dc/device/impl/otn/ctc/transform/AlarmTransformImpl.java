...
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.SetAlarmAttrInputBuilder;
 ...
 * @version V1.0.0
 */
public class AlarmTransformImpl extends AbstractCtcTransformer implements CommonTransform, EnumTransform, ServiceTransform {
    public List<AlarmAttr> devAlarmAttrToApiList(List<
            org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.alarm.attrs.grouping.AlarmAttr> list){
        if(list==null || list.isEmpty()){
            return null;
        }
        List<AlarmAttr> resultList = new LinkedList<>();
        for(org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.alarm.attrs.grouping.AlarmAttr e : list){
    ...
    public AlarmAttrBuilder devAlarmAttrToApi(
            org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.alarm.attrs.grouping.AlarmAttr alarmAttr){
        if(alarmAttr==null){
            return null;
        }
    ...
    public List<AlarmMaskState> devAlarmMaskStateToApi(
            List<org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev240702.alarm.mask.states.AlarmMaskState> list){
        if(list==null || list.isEmpty()){
            return null;
        }
        List<AlarmMaskState> resultList = new LinkedList<>();
        for(org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev240702.alarm.mask.states.AlarmMaskState e : list){
    ...
    public AlarmMaskStateBuilder devAlarmMaskStateToApi(
            org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev240702.alarm.mask.states.AlarmMaskState alarmMaskState){
    ...
    public AlarmMaskStatesBuilder apiAlarmMaskStatesToDev(SetAlarmMaskStatusInput input){
        ...
        List<org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev240702.alarm.mask.states.AlarmMaskState> list = new LinkedList<>();

        for(SetAlarmsMaskStatus e:input.getSetAlarmsMaskStatus().values()){
            org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev240702.alarm.mask.states.AlarmMaskStateBuilder builder
                    = new org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev240702.alarm.mask.states.AlarmMaskStateBuilder();
            org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev240702.alarm.mask.states.AlarmMaskStateKey key
                    = new org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev240702.alarm.mask.states.AlarmMaskStateKey(
    ...
    public List<Tca> devTcaToApiList(List<org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev240702.tcas.grouping.Tca> list){
        if(list==null || list.isEmpty()){
            return null;
        }
        List<Tca> resultList = new LinkedList<>();
        for(org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev240702.tcas.grouping.Tca e : list){
            resultList.add(devTcaToApi(e).build());
        }
        return resultList;
    }

    public TcaBuilder devTcaToApi(org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev240702.tcas.grouping.Tca tca){
        if(tca==null){
            return null;
        }
    ...
    public TcaParameterBuilder devHistoryTcaParameterBuilder(
            org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev240702.tca.TcaParameter tcaParameter){
    ...
    public List<Alarm> devAlarmToApiList(List<org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev240702.alarms.grouping.Alarm> list){
        if(list==null || list.isEmpty()){
            return null;
        }
        List<Alarm> resultList = new LinkedList<>();
        for(org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev240702.alarms.grouping.Alarm e : list){
            resultList.add(devAlarmToApi(e).build());
        }
        return resultList;
    }

    public AlarmBuilder devAlarmToApi(org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev240702.alarms.grouping.Alarm alarm){
        if(alarm==null){
            return null;
        }
    ...
    public org.opendaylight.yang.gen.v1.com.optel.yang.otn
            .extension.rev210329.SetAlarmMaskBatchInput apiAlarmMaskToDev(SetAlarmMaskBatchInput input){
        if(input==null){
            return null;
        }
        org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.SetAlarmMaskBatchInputBuilder builder
                = new org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.SetAlarmMaskBatchInputBuilder();
