...
final class AugmentResolver implements Mutable {
    private static final Logger LOG = LoggerFactory.getLogger(AugmentResolver.class);
    ...
    AbstractAugmentGenerator getAugment(final AugmentEffectiveStatement statement) {
        ...
        LOG.error("Failed to resolve {} in {}", statement, stack);
