...
final class DefaultYangParser implements YangParser {
    private static final Logger LOG = LoggerFactory.getLogger(DefaultYangParser.class);
    ...
    static YangParserException decodeReactorException(final ReactorException reported) {
        ...
        LOG.error("Failed to assemble sources , Yang Module error.{}", reported.getMessage());
