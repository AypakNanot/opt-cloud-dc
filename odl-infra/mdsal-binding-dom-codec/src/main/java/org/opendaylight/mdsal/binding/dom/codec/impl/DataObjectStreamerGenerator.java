...
final class DataObjectStreamerGenerator<T extends DataObjectStreamer<?>> implements ClassGenerator<T> {
    ...
    private static final Generic BB_VOID = Sort.describe(void.class);
    private static final Generic BB_DATAOBJECT = Sort.describe(DataObject.class);
    private static final Generic BB_DOSR = Sort.describe(DataObjectSerializerRegistry.class);
    private static final Generic BB_BESV = Sort.describe(BindingStreamEventWriter.class);
    private static final Generic BB_IOX = Sort.describe(IOException.class);
