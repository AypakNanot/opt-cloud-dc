...
/**
 * <pre>
 * opt-cloud-dc - IDeviceServiceOtnCtc
 * </pre>
 * OTN CTC 设备服务
 * <pre>
 * date              time          author
 ...
 * @version V2.0.0
 */
public interface IDeviceServiceOtnCtc extends IDeviceServiceOtn {
    /**
     * 当前服务支持的Yang Mode类型
     *
     * @return 支持的类型
    ...
    default Collection<YangMode> supportDevice() {
        return CollUtil.newArrayList(YangMode.typeOf(YangType.OTN_CTC));
    }
}