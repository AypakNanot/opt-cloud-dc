...
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev210131.SetPmStateInputBuilder;
 ...
 * 2021/10/13 14:31
 */
public class PmStateTransformImpl extends AbstractCtcTransformer implements PerformanceTransform {

    public List<PmState> devPmStateToApiList(Collection<org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev210131.pm.states.PmState> pmStates){
        if(CollectionUtil.isEmpty(pmStates)){
            return null;
        }
        List<PmState> pmStateList = new ArrayList<>();
        for(org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev210131.pm.states.PmState pmState:pmStates){
     ...
     * @return api
     */
    public PmStateBuilder devPmStateToApi(org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev210131.pm.states.PmState pmState){
        if(pmState == null){
            return null;
        }
    ...
    public org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev210131.SetPmStateInput apiSetPmStateInputDev(SetPmStateInput setPmStateInput){
