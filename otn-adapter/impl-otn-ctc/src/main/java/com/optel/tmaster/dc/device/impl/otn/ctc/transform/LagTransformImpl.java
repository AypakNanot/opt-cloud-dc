...
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.lag.parameter.grouping.PortMembers;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.lag.parameter.grouping.PortMembersBuilder;
...
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.port.member.grouping.PortMember;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.port.member.grouping.PortMemberBuilder;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.port.member.grouping.PortMemberKey;
 ...
 * @since 2021/10/16
 **/
public class LagTransformImpl extends AbstractCtcTransformer implements CommonTransform , EnumTransform {
    ...
    public List<LagParameter> devLagParameterToApi(Collection<org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.lag.parameters.grouping.LagParameter> parameters){
        List<LagParameter> lagParameters=new ArrayList<>();
        if(parameters==null){
            return lagParameters;
        }
        for(org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.lag.parameters.grouping.LagParameter lagParameter:parameters){
