...
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.CreateEthLanServiceInput;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.CreateEthLanServiceInputBuilder;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.CreateServiceOutGrouping;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.create.eth.lan.service.in.grouping.NnisBuilder;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.create.eth.lan.service.in.grouping.NnisKey;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.create.eth.lan.service.in.grouping.UnisBuilder;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.create.eth.lan.service.in.grouping.UnisKey;
...
public class EthLanTransformImpl extends VsiTransformImpl {
    ...
    public CreateEthLanServiceInput apiCreateEthLanServiceInputToDev(CreateEthLanServiceNeInput input){
        ...
        org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.BasicParamGrouping basicParamGrouping = apiBasicParamGroupingToDev(input);
        CreateEthLanServiceInputBuilder builder = new CreateEthLanServiceInputBuilder(basicParamGrouping);
        if(input.getUnis() != null){
            List<org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.create.eth.lan.service.in.grouping.Unis> unisList = new ArrayList<>();
        ...
        if(input.getNnis() != null){
            List<org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.create.eth.lan.service.in.grouping.Nnis> nniList = new ArrayList<>();
