 ...
 * @since 2021/10/12
 **/
public class ClockTransformImpl extends AbstractCtcTransformer implements CommonTransform, EnumTransform {
    public SyncClockSourceBuilder apiSyncClockSourceToDev(org.opendaylight.yang.gen.v1.com.optel.yang.api.optel.clock.rev210927.SyncClockSource syncClockSource) {
    ...
    public GetSyncSourceClockOutputBuilder devSyncSourceClockToApi(SyncClockSources syncClockSources) {
        ...
        List<org.opendaylight.yang.gen.v1.com.optel.yang.api.optel.clock.rev210927.sync.clock.sources.group.SyncClockSource> clockSources = new ArrayList<>();
        ...
        for (org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.clock.rev210820.SyncClockSource syncClockSource : syncClockSources.getSyncClockSource().values()) {
            ...
            clockSources.add(clockSource.build());
        }
        builder.setSyncClockSource(ltm(clockSources));
        return builder;
    }
    ...
    public Get2mExtClockOutputBuilder devGet2mExtClockOutputToApi(Ext2mClocks ext2mClocks) {
        ...
        List<org.opendaylight.yang.gen.v1.com.optel.yang.api.optel.clock.rev210927.ext.clock._2m.grouping.Ext2mClock> ext2mClockList = new ArrayList<>();
        for (org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.clock.rev210820.Ext2mClock ext2mClock : ext2mClocks.getExt2mClock().values()) {
            ...
            ext2mClockList.add(clock.build());
        }
        builder.setExt2mClock(ltm(ext2mClockList));
        return builder;
    }
