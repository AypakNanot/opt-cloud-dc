 ...
 * 2021/10/9 14:37
 */
public class TcmTransformImpl extends AbstractCtcTransformer implements CommonTransform, EnumTransform {

    public List<TcmParameter> devTcmToApiList (Collection<org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.tcm.parameters.grouping.TcmParameter> tcmParameters){
        if(tcmParameters == null){
            return null;
        }
        List<TcmParameter> res = new ArrayList<>();
        for(org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.tcm.parameters.grouping.TcmParameter tcmParameter: tcmParameters){
            res.add(devTcmToApi(tcmParameter).build());
        }
        return res;
    }

    public TcmParameterBuilder devTcmToApi(org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.tcm.parameters.grouping.TcmParameter tcmParameter){
