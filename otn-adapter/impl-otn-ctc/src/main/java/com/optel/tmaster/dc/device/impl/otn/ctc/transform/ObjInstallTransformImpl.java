...
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.SetEqTypeInput;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.SetEqTypeInputBuilder;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.SetEqTypeOutput;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.SetPtpTypeInputBuilder;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.SetPtpTypeOutput;
...
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.set.eq.type.in.parameter.grouping.SetEqTypeInParameter;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.set.eq.type.in.parameter.grouping.SetEqTypeInParameterBuilder;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.set.eq.type.in.parameter.grouping.SetEqTypeInParameterKey;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.set.ptp.type.in.parameter.grouping.SetPtpTypeInParameter;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.set.ptp.type.in.parameter.grouping.SetPtpTypeInParameterBuilder;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.set.ptp.type.in.parameter.grouping.SetPtpTypeInParameterKey;
 ...
 * @since 2021/10/14
 **/
public class ObjInstallTransformImpl extends AbstractCtcTransformer implements CommonTransform, EnumTransform, ServiceTransform {
    public List<org.opendaylight.yang.gen.v1.com.optel.yang.api.otn.extension.rev210927.eh.installation.capabilitys.grouping.EhInstallationCapability> devEhInstallationToApi(List<EhInstallationCapability> capabilities){
        if(capabilities==null){
            return new ArrayList<>();
        }
        List<org.opendaylight.yang.gen.v1.com.optel.yang.api.otn.extension.rev210927.eh.installation.capabilitys.grouping.EhInstallationCapability> ehInstallationCapabilities=new ArrayList<>();
        for(EhInstallationCapability item:capabilities){
            org.opendaylight.yang.gen.v1.com.optel.yang.api.otn.extension.rev210927.eh.installation.capabilitys.grouping.EhInstallationCapabilityBuilder builder=new org.opendaylight.yang.gen.v1.com.optel.yang.api.otn.extension.rev210927.eh.installation.capabilitys.grouping.EhInstallationCapabilityBuilder();
            builder.setActualEqType(item.getActualEqType());
            builder.setEqType(item.getEqType());
            builder.withKey(new org.opendaylight.yang.gen.v1.com.optel.yang.api.otn.extension.rev210927.eh.installation.capabilitys.grouping.EhInstallationCapabilityKey(item.key().getName()));
            builder.setName(item.getName());
            builder.setSupportEqType(item.getSupportEqType());
            ehInstallationCapabilities.add(builder.build());
        }
    ...
    public org.opendaylight.yang.gen.v1.com.optel.yang.api.otn.extension.rev210927.SetEqTypeOutputBuilder devEqTypeOutputToApi(SetEqTypeOutput grouping){
        ...
        for(org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.set.eq.type.out.parameter.grouping.SetEqTypeOutParameter parameter:grouping.getSetEqTypeOutParameter().values()){
    ...
    public QueryEqInstallationOutputBuilder devQueryEqInstallationOutputToApi(List<EqInstallationCapability> list){
        ...
        for(EqInstallationCapability item:list){
            org.opendaylight.yang.gen.v1.com.optel.yang.api.otn.extension.rev210927.eq.installation.capabilitys.grouping.EqInstallationCapabilityBuilder capabilityBuilder=new org.opendaylight.yang.gen.v1.com.optel.yang.api.otn.extension.rev210927.eq.installation.capabilitys.grouping.EqInstallationCapabilityBuilder();
    ...
    private  List<PtpCapability> devPtpCapabilityToApi(Collection<org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.eq.installation.capability.grouping.PtpCapability> ptpCapabilities){
        if(ptpCapabilities==null){
            return new ArrayList<>();
        }
        List<PtpCapability> capabilityList=new ArrayList<>();
        for(org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.eq.installation.capability.grouping.PtpCapability item:ptpCapabilities){
    ...
    public org.opendaylight.yang.gen.v1.com.optel.yang.api.otn.extension.rev210927.SetPtpTypeOutputBuilder devSetPtpTypeOutputToApi(SetPtpTypeOutput output){
        ...
        for(org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev210329.set.ptp.type.out.parameter.grouping.SetPtpTypeOutParameter item:output.getSetPtpTypeOutParameter().values()){
