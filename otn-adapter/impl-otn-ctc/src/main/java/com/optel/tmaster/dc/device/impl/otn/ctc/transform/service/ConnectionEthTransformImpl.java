...
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eth.rev240702.CreateEthConnectionInputBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eth.rev240702.CreateEthConnectionOutput;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eth.rev240702.create.eth.connection.input.EthNniBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eth.rev240702.create.eth.connection.input.EthUniBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eth.rev240702.create.eth.connection.input.PrimaryNni2Builder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eth.rev240702.create.eth.connection.input.PrimaryNniBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eth.rev240702.create.eth.connection.input.SecondaryNni2Builder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eth.rev240702.create.eth.connection.input.SecondaryNniBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eth.rev240702.create.eth.connection.input.eth.nni.FtpClientVlanSpecBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eth.rev240702.create.eth.connection.input.eth.nni.FtpVlanSpecBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eth.rev240702.create.eth.connection.input.eth.uni.ClientVlanSpecBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eth.rev240702.create.eth.connection.input.eth.uni.UniVlanSpecBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eth.rev240702.create.eth.connection.output.err.or.ok.OperOk;
...
public class ConnectionEthTransformImpl extends ConnectionTransformImpl {
    ...
    public CreateEthConnectionInput apiCreateEthConnectionInputToDev(CreateEthConnectionNeInput input){
        ...
        if(input.getEthNni() != null){
            ...
            ethNniBuilder.setTpid(apiTpidDifinitionToDev(ethNni.getTpid()));
        ...
        org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.otn.rev240702.Nni primaryNni = apiNniToDev(input.getPrimaryNni());
        if(input.getPrimaryNni() != null && primaryNni != null){
            ...
            if (ftpClientVlanSpec != null) {
                primaryNniBuilder.setFtpClientVlanSpec(new org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eth.rev240702.create.eth.connection.input.primary.nni.FtpClientVlanSpecBuilder(ftpClientVlanSpec).build());
            }
            VlanSpec ftpVlanSpec = apiVlanSpecToDev(input.getPrimaryNni().getFtpVlanSpec());
            if(ftpVlanSpec != null){
                primaryNniBuilder.setFtpVlanSpec(new org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eth.rev240702.create.eth.connection.input.primary.nni.FtpVlanSpecBuilder(ftpVlanSpec).build());
            }
        ...
        org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.otn.rev240702.Nni primaryNni2 = apiNniToDev(input.getPrimaryNni2());
        if(input.getPrimaryNni2() != null && primaryNni2 != null){
            ...
            if(ftpVlanSpec != null){
                primaryNni2Builder.setFtpVlanSpec(new org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eth.rev240702.create.eth.connection.input.primary.nni2.FtpVlanSpecBuilder(ftpVlanSpec).build());
        ...
        org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.connection.rev240702.Capacity requestedCapacity = apiCapacityToDev(input.getRequestedCapacity());
        if(requestedCapacity != null){
            builder.setRequestedCapacity(new org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.connection.rev240702.create.connection.RequestedCapacityBuilder(requestedCapacity).build());
        }
        if(input.getSecondaryNni() != null){
            org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.otn.rev240702.Nni secondaryNni = apiNniToDev(input.getSecondaryNni());
            if(secondaryNni != null){
                ...
                if(ftpClientVlanSpec != null){
                    secondaryNniBuilder.setFtpClientVlanSpec(new org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eth.rev240702.create.eth.connection.input.secondary.nni.FtpClientVlanSpecBuilder(ftpClientVlanSpec).build());
                }
                VlanSpec ftpVlanSpec = apiVlanSpecToDev(input.getSecondaryNni().getFtpVlanSpec());
                if(ftpVlanSpec != null){
                    secondaryNniBuilder.setFtpVlanSpec(new org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eth.rev240702.create.eth.connection.input.secondary.nni.FtpVlanSpecBuilder(ftpVlanSpec).build());
                }
                builder.setSecondaryNni(secondaryNniBuilder.build());
            }
        }
        if(input.getSecondaryNni2() != null){
            org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.otn.rev240702.Nni secondaryNni2 = apiNniToDev(input.getSecondaryNni2());
            if(secondaryNni2 != null){
                ...
                if(ftpVlanSpec != null){
                    secondaryNni2Builder.setFtpVlanSpec(new org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eth.rev240702.create.eth.connection.input.secondary.nni2.FtpVlanSpecBuilder(ftpVlanSpec).build());
                }
    ...
    public CreateEthConnectionNeOutput devCreateEthConnectionOutputToApi(CreateEthConnectionOutput createEthConnectionOutput){
        ...
        if (createEthConnectionOutput.getErrOrOk().implementedInterface().equals(OperOk.class)) {
            OperOk operOk = (OperOk) createEthConnectionOutput.getErrOrOk();
