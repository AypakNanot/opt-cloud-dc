 ...
 * 2021/10/12 15:02
 */
public class PerformanceTransformImpl extends AbstractCmccTransformer implements PerformanceTransform {

    public Map<PerformanceKey,Performance> devPerformanceToApi(Map<org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.performances.grouping.PerformanceKey,
            org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.performances.grouping.Performance> performances){
        if(MapUtil.isEmpty(performances)){
            return null;
        }
        Map<PerformanceKey,Performance> res = new HashMap<>(performances.size());
        for(org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.performances.grouping.Performance performance: performances.values()){
     ...
     * @return api
     */
    public Performance devPerformanceToApi(org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.performances.grouping.Performance performance){
        if(performance == null){
            return null;
        }
