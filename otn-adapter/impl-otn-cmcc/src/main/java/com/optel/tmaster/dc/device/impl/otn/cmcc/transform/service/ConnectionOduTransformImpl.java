...
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.otn.rev200708.CreateOduConnectionInput;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.otn.rev200708.CreateOduConnectionInputBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.otn.rev200708.CreateOduConnectionOutput;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.otn.rev200708.create.odu.connection.input.ClientSideNniBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.otn.rev200708.create.odu.connection.input.PrimaryNni2Builder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.otn.rev200708.create.odu.connection.input.PrimaryNniBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.otn.rev200708.create.odu.connection.input.SecondaryNni2Builder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.otn.rev200708.create.odu.connection.input.SecondaryNniBuilder;
...
public class ConnectionOduTransformImpl extends ConnectionTransformImpl{
    ...
    public CreateOduConnectionNeOutput devCreateOduConnectionOutputToApi(CreateOduConnectionOutput output){
        ...
        org.opendaylight.yang.gen.v1.com.optel.yang.api.optel.connection.rev210927.Connection connection = devConnectionToApi(output.getConnection());
        if(connection != null){
