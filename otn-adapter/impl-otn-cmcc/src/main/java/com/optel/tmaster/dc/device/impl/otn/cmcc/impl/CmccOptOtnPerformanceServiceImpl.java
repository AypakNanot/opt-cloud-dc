...
//import com.optel.tmaster.dc.device.impl.otn.cmcc.transform.PerformanceTransformImpl;
//import com.optel.tmaster.dc.device.impl.otn.cmcc.transform.PmStateTransformImpl;
//import com.optel.tmaster.dc.device.impl.otn.cmcc.transform.TcaTransformImpl;
...
//import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev190213.TcaParameter;
//import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev190213.TcaParameters;
//import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev190213.tca.parameters.TcaParameterBuilder;
//import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev190213.tca.parameters.TcaParameterKey;
//import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.AccPerformanceService;
//import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.GetHistoryPerformanceMonitoringDataInputBuilder;
//import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.GetHistoryPerformanceMonitoringDataOutput;
//import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.Performances;
//import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.performances.grouping.Performance;
//import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.performances.grouping.PerformanceKey;
...
// * 2020/4/28 15:37
// */
//public class CmccOptOtnPerformanceServiceImpl extends BaseOptOtnPerformanceServiceImpl implements IDeviceServiceOtnCmcc {
//
//    @Override
...
//        getHistoryPerformanceMonitoringDataInputBuilder.setPmParameterName(input.getPmParameterName());
//        PerformanceTransformImpl performanceTransform = new PerformanceTransformImpl();
...
//            InstanceIdentifier<org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev190213.tca.parameters.TcaParameter> iid = create(TcaParameters.class).child(org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev190213.tca.parameters.TcaParameter.class, new TcaParameterKey(tcaTransform.apiGranularityToDev(input.getGranularity()),
//                    input.getObjectName(), input.getPmParameterName(), tcaTransform.apiThresholdTypeToDev(input.getThresholdType())));
//            //从设备查询数据
//            TcaParameter tcaParameter = MountTools.queryFromOperational(input.getNeId(), iid);
...
//        if (CollUtils.isNotEmpty(tcaParameterList)) {
...
//     * @return 过滤结果
//     */
//    private List<TcaParameter> tcaParameterFilter(List<TcaParameter> tcaParameterList, GetTcaParameterInput input) {
//        String objName = input.getObjectName();
//        int objType = 0;
//        if (input.getObjectType() != null) {
//            objType = input.getObjectType().intValue();
...
//        }
//        List<TcaParameter> resList = new ArrayList<>();
//        for (TcaParameter tcaParameter : tcaParameterList) {
...
//        OptOtnExtensionService optOtnExtensionService = MountTools.getRpcService(input.getNeId(), OptOtnExtensionService.class);
//        org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.GetTcaParameterInputBuilder getTcaParameterInputBuilder = new org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.GetTcaParameterInputBuilder();
//        TcaTransformImpl tcaTransform = new TcaTransformImpl();
...
//        Future<RpcResult<org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.GetTcaParameterOutput>> resultFuture = optOtnExtensionService.getTcaParameter(getTcaParameterInputBuilder.build());
...
//        );
//        InstanceIdentifier<org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev190213.tca.parameters.TcaParameter> iid = create(TcaParameters.class).child(org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev190213.tca.parameters.TcaParameter.class, tcaParameterKey);
...
//        AccPerformanceService accPerformanceService = MountTools.getRpcService(input.getNeId(), AccPerformanceService.class);
//        org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.GetAllPmStateInputBuilder getAllPmStateInputBuilder = new org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.GetAllPmStateInputBuilder();
...
//        //获取设备rpc接口返回的值
//        Future<RpcResult<org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.GetAllPmStateOutput>> rpcResultFuture = accPerformanceService.getAllPmState(getAllPmStateInputBuilder.build());
//        return RpcResultUtil.buildFutureResult(rpcResultFuture, (rpcResult -> {
//            GetAllPmStateOutputBuilder getAllPmStateOutputBuilder = new GetAllPmStateOutputBuilder();
//            if (rpcResult != null) {
//                if (rpcResult.getPmStates() != null && rpcResult.getPmStates().getPmState() != null) {
//                    PmStatesBuilder pmStatesBuilder = new PmStatesBuilder();
//                    pmStatesBuilder.setPmState(ltm(pmStateTransform.devPmStateToApiList(rpcResult.getPmStates().getPmState().values())));
...
//        AccPerformanceService accPerformanceService = MountTools.getRpcService(input.getNeId(), AccPerformanceService.class);
//        org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.SetPmStateInputBuilder setPmStateInputBuilder = new org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.SetPmStateInputBuilder(new PmStateTransformImpl().apiSetPmStateInputDev(input));
