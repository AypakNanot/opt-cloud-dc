...
import org.opendaylight.yang.gen.v1.com.optel.devconf.opt.otn.ext.dev.rev210422.SelectTpidsOutputBuilder;
 ...
 * @since 2021/10/12
 **/
public class TpIdTransformImpl extends AbstractCmccTransformer implements CommonTransform, EnumTransform {

    public List<Tpid> devSelectTpidsOutputToApi( Collection<org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.tpid.grouping.Tpid> tpids) {

        SelectTpidsOutputBuilder builder = new SelectTpidsOutputBuilder();
        if (tpids == null) {
            return null;
        }
        List<Tpid> tpidList = new ArrayList<>();
        for (org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.tpid.grouping.Tpid tpid : tpids) {
    ...
    public org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.tpid.grouping.TpidBuilder apiTpidToDev(ModifyTpidsInput input){
        org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.tpid.grouping.TpidBuilder builder=new org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.tpid.grouping.TpidBuilder();
        if(input==null){
            return null;
        }
        builder.withKey(new org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.tpid.grouping.TpidKey(input.getName()));
