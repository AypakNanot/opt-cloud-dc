...
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.CreateEosConnectionInput;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.CreateEosConnectionInputBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.CreateEosConnectionOutput;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.create.eos.connection.input.EthUniBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.create.eos.connection.input.eth.uni.ClientVlanSpecBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.create.eos.connection.input.eth.uni.UniVlanSpecBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.nni.grouping.EosPacBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.nni.grouping.LcasAttrBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.nni.grouping.MultiSvlanAttrBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.nni.grouping.PrimaryNniBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.nni.grouping.SecondaryNniBuilder;
...
public class ConnectionEosTransformImpl extends ConnectionTransformImpl {
    ...
    public org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.nni.grouping.SecondaryNni apiSecondaryNniToDev(SecondaryNni secondaryNni){
        if(secondaryNni == null){
            return null;
        }
        org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.otn.rev200708.Nni devSecondaryNni = apiNniToDev(secondaryNni);
        ...
        if(ftpClientVlanSpec != null){
            secondaryNniBuilder.setFtpClientVlanSpec(
                    new org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.nni.grouping.secondary.nni.FtpClientVlanSpecBuilder(ftpClientVlanSpec).build());
        }
        VlanSpec ftpVlanSpec = apiVlanSpecToDev(secondaryNni.getFtpVlanSpec());
        if(ftpVlanSpec != null){
            secondaryNniBuilder.setFtpVlanSpec(new org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.nni.grouping.secondary.nni.FtpVlanSpecBuilder(ftpVlanSpec).build());
        }
        return secondaryNniBuilder.build();
    }

    public org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.nni.grouping.EosPac apiEosPacToDev(EosPac eosPac){
        if(eosPac == null){
            return null;
        }
        ...
        eosPacBuilder.setVcType(apiSwitchTypeToDev(eosPac.getVcType()));
    ...
    public org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.nni.grouping.PrimaryNni apiPrimaryNniToDev(PrimaryNni primaryNni){
        if(primaryNni == null){
            return null;
        }
        org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.otn.rev200708.Nni nni = apiNniToDev(primaryNni);
        if( nni != null){
            ...
            if (ftpClientVlanSpec != null) {
                primaryNniBuilder.setFtpClientVlanSpec(new org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.nni.grouping.primary.nni.FtpClientVlanSpecBuilder(ftpClientVlanSpec).build());
            }
            VlanSpec ftpVlanSpec = apiVlanSpecToDev(primaryNni.getFtpVlanSpec());
            if(ftpVlanSpec != null){
                primaryNniBuilder.setFtpVlanSpec(new org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.nni.grouping.primary.nni.FtpVlanSpecBuilder(ftpVlanSpec).build());
            }
    ...
    public org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.nni.grouping.MultiSvlanAttr apiMultiSvlanAttrToDev(MultiSvlanAttr svlan){
        if(svlan == null){
            return null;
        }
        ...
        if (ftpClientVlanSpec != null) {
            ethFtpAttrBuilder.setFtpClientVlanSpec(new org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.nni.grouping.multi.svlan.attr.FtpClientVlanSpecBuilder(ftpClientVlanSpec).build());
        }
        VlanSpec ftpVlanSpec = apiVlanSpecToDev(svlan.getFtpVlanSpec());
        if(ftpVlanSpec != null){
            ethFtpAttrBuilder.setFtpVlanSpec(new org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.nni.grouping.multi.svlan.attr.FtpVlanSpecBuilder(ftpVlanSpec).build());
        }
        ethFtpAttrBuilder.setTpid(apiTpidDifinitionToDev(svlan.getTpid()));
        return ethFtpAttrBuilder.build();
    }

    private org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.create.eos.connection.input.EthUni apiEthUniToDev(EthUni ethUni){
        if(ethUni == null){
            return null;
        }
    ...
    public org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.eos.rev190213.nni.grouping.LcasAttr apiLcasAttrToDev(LcasAttr lcasAttr){
        if(lcasAttr == null){
            return null;
        }
    ...
    public CreateEosConnectionNeOutput devCreateEosConnectionOutputToApi(CreateEosConnectionOutput output){
        ...
        Connection connection = devConnectionToApi(output.getConnection());
        if(connection != null){
        ...
        if(output.getCreateComponent() != null){
            CreateComponentBuilder createComponentBuilder = new CreateComponentBuilder()
                    ...
                    .setVcConnectionName(output.getCreateComponent().getVcConnectionName());
