...
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.otn.rev200708.Nni;
...
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.CreateSdhConnectionInput;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.CreateSdhConnectionInputBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.CreateSdhConnectionOutput;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.create.sdh.connection.input.PrimaryNni2Builder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.create.sdh.connection.input.PrimaryNniBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.create.sdh.connection.input.SdhNniBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.create.sdh.connection.input.SdhUniBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.create.sdh.connection.input.SecondSdhNniBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.create.sdh.connection.input.SecondSdhUniBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.create.sdh.connection.input.SecondaryNni2Builder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.create.sdh.connection.input.SecondaryNniBuilder;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.create.sdh.connection.input.primary.nni.SdhFtpBuilder;
...
public class ConnectionSdhTransformImpl extends ConnectionTransformImpl {
    ...
    private org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.create.sdh.connection.input.SdhUni apiSdhUniToDev(SdhUni sdhUni){
        if(sdhUni == null){
            return null;
        }
        ...
        sdhUniBuilder.setVcType(apiSwitchTypeToDev(sdhUni.getVcType()));
        return sdhUniBuilder.build();
    }

    private org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.create.sdh.connection.input.SecondSdhUni apiSecondSdhUniToDev(SecondSdhUni secondSdhUni){
        ...
        secondSdhUniBuilder.setVcType(apiSwitchTypeToDev(secondSdhUni.getVcType()));
        return secondSdhUniBuilder.build();
    }

    private org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.create.sdh.connection.input.SdhNni apiSdhNniToDev(SdhNni sdhNni){
        if(sdhNni == null){
            return null;
        }
        ...
        sdhNniBuilder.setVcType(apiSwitchTypeToDev(sdhNni.getVcType()));
        return sdhNniBuilder.build();
    }

    private org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.create.sdh.connection.input.SecondSdhNni apiSecondSdhNniToDev(SecondSdhNni secondSdhNni){
        ...
        secondSdhNniBuilder.setVcType(apiSwitchTypeToDev(secondSdhNni.getVcType()));
        return secondSdhNniBuilder.build();
    }

    private org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.create.sdh.connection.input.PrimaryNni apiPrimaryNniToDev(PrimaryNni primaryNni){
        if(primaryNni == null){
            return null;
        }
        PrimaryNniBuilder primaryNniBuilder = new PrimaryNniBuilder(apiNniToDev(primaryNni));
        org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.SdhFtp sdhFtp = apiSdhFtpToDev(primaryNni.getSdhFtp());
        if(sdhFtp != null){
    ...
    private org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.SdhFtp apiSdhFtpToDev(SdhFtp sdhFtp){
        if(sdhFtp == null){
            return null;
        }
        return new org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.SdhFtp() {
            @Override
            public Class<? extends org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.SdhFtp> implementedInterface() {
                return null;
            }

            @Override
            public ClientSignalType getSdhType() {
                return apiClientSignalTypeToDev(sdhFtp.getSdhType());
            }

            @Override
            public SwitchType getVcType() {
                return apiSwitchTypeToDev(sdhFtp.getVcType());
            }

            @Override
            public String getMappingPath() {
                return sdhFtp.getMappingPath();
            }
    ...
    private org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.create.sdh.connection.input.SecondaryNni apiSecondaryNniToDev(SecondaryNni secondaryNni){
        ...
        org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.SdhFtp sdhFtp = apiSdhFtpToDev(secondaryNni.getSdhFtp());
        if(sdhFtp != null){
            secondaryNniBuilder.setSdhFtp(new org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.create.sdh.connection.input.secondary.nni.SdhFtpBuilder(sdhFtp).build());
        }
        return secondaryNniBuilder.build();
    }

    private org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.create.sdh.connection.input.PrimaryNni2 apiPrimaryNni2ToDev(PrimaryNni2 primaryNni2){
        if(primaryNni2 == null){
            return null;
        }
        ...
        org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.SdhFtp sdhFtp = apiSdhFtpToDev(primaryNni2.getSdhFtp());
        if(sdhFtp != null){
            primaryNni2Builder.setSdhFtp(new org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.create.sdh.connection.input.primary.nni2.SdhFtpBuilder(sdhFtp).build());
        }
        return primaryNni2Builder.build();
    }

    private org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.create.sdh.connection.input.SecondaryNni2 apiSecondaryNni2ToDev(SecondaryNni2 secondaryNni2){
        ...
        org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.SdhFtp sdhFtp = apiSdhFtpToDev(secondaryNni2.getSdhFtp());
        if(sdhFtp != null){
            secondaryNni2Builder.setSdhFtp(new org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.create.sdh.connection.input.secondary.nni2.SdhFtpBuilder(sdhFtp).build());
        }
    ...
    public CreateSdhConnectionNeOutput devCreateSdhConnectionOutputToApi(CreateSdhConnectionOutput output){
        if(output == null || output.getConnection() == null){
            return null;
        }
        CreateSdhConnectionNeOutputBuilder createSdhConnectionNeOutputBuilder = new CreateSdhConnectionNeOutputBuilder();
        Collection<org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.create.sdh.connection.output.Connection> connections = output.getConnection().values();
        if(CollectionUtil.isNotEmpty(connections)){
            List<ConnectionBuilder> result = new ArrayList<>();
            for(org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.sdh.rev200708.create.sdh.connection.output.Connection connection:connections){
                ...
                result.add(connectionBuilder);
            }
            Map<ConnectionKey, Connection> ms = result.stream().collect(Collectors.toMap(ConnectionBuilder::key, ConnectionBuilder::build));
            createSdhConnectionNeOutputBuilder.setConnection(ms);
        }
        if(output.getCreateComponent() != null){
            CreateComponentBuilder createComponentBuilder = new CreateComponentBuilder()
                    .setCtpName(output.getCreateComponent().getCtpName())
                    .setFtpName(output.getCreateComponent().getFtpName());
