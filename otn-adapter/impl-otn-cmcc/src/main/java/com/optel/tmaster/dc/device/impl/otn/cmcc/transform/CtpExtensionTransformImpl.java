...
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.ctp.extension.parameter.grouping.EthCtpExtension;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.ctp.extension.parameter.grouping.EthCtpExtensionBuilder;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.ctp.extension.parameter.grouping.OduCtpExtension;
 ...
 * 2021/10/12 11:25
 */
public class CtpExtensionTransformImpl extends AbstractCmccTransformer implements CommonTransform, ServiceTransform {
     ...
     * @return api List
     */
    public List<CtpExtension> devCtpExtensionToApiList(Collection<org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.ctp.extension.grouping.CtpExtension> ctpExtensions){
        if(CollectionUtil.isEmpty(ctpExtensions)){
            return null;
        }
        List<CtpExtension> res = new ArrayList<>();
        for(org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.ctp.extension.grouping.CtpExtension ctpExtension :ctpExtensions){
     ...
     * @return api
     */
    public CtpExtensionBuilder devCtpExtensionToApi(org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.ctp.extension.grouping.CtpExtension ctpExtension){
    ...
    public StormSuppressionPac
            devStormSuppressionToApi(org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.eth.ctp.extension.parameter.grouping.StormSuppressionPac stormSuppressionPac){
    ...
    public org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.eth.ctp.extension.parameter.grouping.StormSuppressionPac
                apiStormSuppressionToDev(org.opendaylight.yang.gen.v1.com.optel.devconf.opt.otn.ext.dev.rev210422.modify.eth.ctp.input.StormSuppressionPac stormSuppressionPac){
        if(stormSuppressionPac==null){
            return null;
        }
        org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.eth.ctp.extension.parameter.grouping.StormSuppressionPacBuilder builder
                = new org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.eth.ctp.extension.parameter.grouping.StormSuppressionPacBuilder();
        builder.setBroadcastSuppress(stormSuppressionPac.getBroadcastSuppress());
        builder.setUnknownMulticastSuppress(stormSuppressionPac.getUnknownMulticastSuppress());
        builder.setUnknownUnicastSuppress(stormSuppressionPac.getUnknownUnicastSuppress());
        return builder.build();
    ...
    public org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.ctp.extension.grouping.CtpExtension
            apiCtpExtensionToDev(ModifyEthCtpInput input){
        org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.ctp.extension.grouping.CtpExtensionBuilder ctpExtensionBuilder
                = new org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.ctp.extension.grouping.CtpExtensionBuilder();
            ...
            if(input.getEgressCapacity()!=null){
                ...
                if(egressCapacity!=null){
                    ethCtpExtensionBuilder.setEgressCapacity(
                            new org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805
        ...
        if (input.getStormSuppressionPac()!=null) {
            //修改风暴压抑制门限
            org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.eth.ctp.extension.parameter.grouping.StormSuppressionPac stormSuppressionPac
        ...
        ctpExtensionBuilder
                .withKey(new org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.ctp.extension.grouping.CtpExtensionKey(input.getCtpName()))
