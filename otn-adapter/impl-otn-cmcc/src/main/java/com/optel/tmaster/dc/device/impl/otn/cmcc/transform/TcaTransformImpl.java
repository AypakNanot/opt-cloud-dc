 ...
 * 2021/10/12 15:02
 */
public class TcaTransformImpl extends AbstractCmccTransformer implements PerformanceTransform {
     ...
     * @return api
     */
    public List<TcaParameter> devTcaToApiList(List<org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev190213.TcaParameter> tcaParameters){
        if(CollUtil.isEmpty(tcaParameters)){
            return null;
        }
        List<TcaParameter> res = new ArrayList<>();
        for(org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev190213.TcaParameter tcaParameter: tcaParameters){
            res.add(devTcaToApi(tcaParameter));
        }
        return res;
    }
     ...
     * @return api
     */
    public TcaParameter devTcaToApi(org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev190213.TcaParameter tcaParameter){
     ...
     * @return api
     */
    public List<org.opendaylight.yang.gen.v1.com.optel.yang.api.otn.extension.rev210927.tca.parameters.grouping.TcaParameter> devTcaExtensionToApiList(Map<org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.tca.parameters.grouping.TcaParameterKey, org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.tca.parameters.grouping.TcaParameter> tcaParameters){
        ...
        for(org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.tca.parameters.grouping.TcaParameter tcaParameter: tcaParameters.values()){
     ...
     * @return api
     */
    public org.opendaylight.yang.gen.v1.com.optel.yang.api.otn.extension.rev210927.tca.parameters.grouping.TcaParameter devTcaExtensionToApi(org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.tca.parameters.grouping.TcaParameter tcaParameter){
        if(tcaParameter == null){
            return null;
        }
