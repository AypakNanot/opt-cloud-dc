...
public interface PerformanceTransform extends ITransform,CommonTransform {
     ...
     * @return api
     */
    default DigitalOrAnalog devDigitalOrAnalogToApi(org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.performances.grouping.performance.DigitalOrAnalog digitalOrAnalog) {
        if(digitalOrAnalog == null) {
            return null;
        }
        if(digitalOrAnalog instanceof org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.performances.grouping.performance.digital.or.analog.Digital){
            DigitalBuilder digitalBuilder = new DigitalBuilder();
            digitalBuilder.setDigitalPmValue(devRealToApi(((org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.performances.grouping.performance.digital.or.analog.Digital) digitalOrAnalog).getDigitalPmValue()));
            return digitalBuilder.build();
        }
        if(digitalOrAnalog instanceof org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.performances.grouping.performance.digital.or.analog.Analog){
            AnalogBuilder analogBuilder = new AnalogBuilder();
            org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.performances.grouping.performance.digital.or.analog.analog.AnalogPmValue analogPmValue =
                    ((org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.performances.grouping.performance.digital.or.analog.Analog)digitalOrAnalog).getAnalogPmValue();
     ...
     * @return dev
     */
    default org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.performances.grouping.performance.DigitalOrAnalog apiDigitalOrAnalogToDev(DigitalOrAnalog digitalOrAnalog) {
        if(digitalOrAnalog == null) {
            return null;
        }
        if(digitalOrAnalog instanceof Digital){
            org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.performances.grouping.performance.digital.or.analog.DigitalBuilder digitalBuilder = new org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.performances.grouping.performance.digital.or.analog.DigitalBuilder();
        ...
        if(digitalOrAnalog instanceof Analog){
            org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.performances.grouping.performance.digital.or.analog.AnalogBuilder analogBuilder = new org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.performances.grouping.performance.digital.or.analog.AnalogBuilder();
            AnalogPmValue analogPmValue =((Analog)digitalOrAnalog).getAnalogPmValue();
            org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.performances.grouping.performance.digital.or.analog.analog.AnalogPmValueBuilder analogPmValueBuilder = new org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.performance.rev190213.performances.grouping.performance.digital.or.analog.analog.AnalogPmValueBuilder();
