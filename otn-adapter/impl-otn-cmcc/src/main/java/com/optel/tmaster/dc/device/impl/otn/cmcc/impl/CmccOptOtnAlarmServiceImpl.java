...
import com.optel.tmaster.dc.device.impl.otn.cmcc.transform.AlarmTransformImpl;
...
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.GetAlarmAttrInputBuilder;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.GetAlarmAttrOutput;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.OptOtnExtensionService;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.SetAlarmAttrOutput;
import org.opendaylight.yang.gen.v1.com.optel.yang.otn.extension.rev200805.alarm.attrs.grouping.AlarmAttr;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev190213.*;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev190213.alarm.mask.states.AlarmMaskState;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev190213.alarms.grouping.Alarm;
import org.opendaylight.yang.gen.v1.urn.ccsa.yang.acc.alarms.rev190213.tcas.grouping.Tca;
 ...
 * @version V1.0.0
 */
public class CmccOptOtnAlarmServiceImpl extends BaseOptOtnAlarmServiceImpl implements IDeviceServiceOtnCmcc {

    private static final Logger LOG = LoggerFactory.getLogger(CmccOptOtnAlarmServiceImpl.class);
        ...
        try {
            ...
            if (rpcResult.isSuccessful()) {
                ...
                if (getHistoryAlarmsOutput.getTcas() != null && getHistoryAlarmsOutput.getTcas().getTca() != null) {
                    getHistoryTcaNeOutputBuilder.setTca(ltm(
                            new AlarmTransformImpl().devTcaToApiList(
    ...
    public void filterAlarm(List<Alarm> list, PerceivedSeverity perceivedSeverity, DateAndTime startTime, DateAndTime endTime) {
        if (perceivedSeverity != null || endTime != null || startTime != null) {
            for (int i = 0; i < list.size(); i++) {
